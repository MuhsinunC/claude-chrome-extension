const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/index-D74dnORg.js',
      'assets/permissions-BsMI2TUG.js',
      'assets/punycode.es6-BmPUeujg.js',
    ])
) => i.map((i) => d[i]);
import { g as e, a as t } from './client-BLU1RtqI.js';
import {
  k as r,
  S as o,
  T as n,
...
import { w as I, P as T } from './SentryService-Bpayo6Ny.js';
var k,
  _ = {},
  E = {};
var x,
  C,
  S = {};
/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ var A =
  (C ||
    ((C = 1),
    (function (e) {
      const t = (function () {
          ...
          ((k = 1),
            ...
            (E.fromByteArray = function (t) {
              for (
                var r, o = t.length, n = o % 3, i = [], a = 16383, c = 0, u = o - n;
                c < u;
                c += a
              )
          ...
          return ((t['-'.charCodeAt(0)] = 62), (t['_'.charCodeAt(0)] = 63), E);
        })(),
        r =
          (x ||
            ((x = 1),
            (S.read = function (e, t, r, o, n) {
              var i,
                a,
                s = 8 * n - o - 1,
                c = (1 << s) - 1,
      ...
      function C(e, t, r) {
        ...
        for (; n < r; ) {
          ...
          (null === i
            ? ((i = 65533), (a = 1))
            : i > 65535 &&
              ((i -= 65536), o.push(((i >>> 10) & 1023) | 55296), (i = 56320 | (1023 & i))),
            o.push(i),
            (n += a));
        }
        return (function (e) {
          ...
          let r = '',
            o = 0;
          for (; o < t; ) r += String.fromCharCode.apply(String, e.slice(o, (o += A)));
          return r;
        })(o);
      }
      ((e.kMaxLength = n),
      ...
      function L(e, t, o, n, i) {
        return ((t = +t), (o >>>= 0), i || $(e, 0, o, 4), r.write(e, t, o, n, 23, 4), o + 4);
      }
      function N(e, t, o, n, i) {
        return ((t = +t), (o >>>= 0), i || $(e, 0, o, 8), r.write(e, t, o, n, 52, 8), o + 8);
      }
      ((a.prototype.slice = function (e, t) {
        ...
        (a.prototype.writeUintLE = a.prototype.writeUIntLE =
          function (e, t, r, o) {
            ((e = +e), (t >>>= 0), (r >>>= 0), o || G(this, e, t, r, Math.pow(2, 8 * r) - 1, 0));
            let n = 1,
              i = 0;
      ...
      function H(e, t, r) {
        if (Math.floor(e) !== e) throw (z(e, r), new q.ERR_OUT_OF_RANGE('offset', 'an integer', e));
                ...
                if ('image' === e.type) {
                  ...
                  if (r.source && 'data' in r.source && r.source.data)
                    return (
                      ...
                      { base64: r.source.data, width: L(n, 'width'), height: L(n, 'height') }
                    );
                }
          }
        }
...
class W {
  ...
  static async fetchCategoryFromAPI(e) {
    ...
    if (t)
      try {
        const r = new URL('/api/web/domain_info/browser_extension', 'https://api.anthropic.com');
...
class H {
  ...
  async dismissStaticIndicatorsForGroup(e) {
    const t =
      (await chrome.storage.local.get(this.DISMISSED_GROUPS_KEY))[this.DISMISSED_GROUPS_KEY] || [];
      ...
      try {
        (await chrome.tabs.group({ tabIds: [t], groupId: r.chromeGroupId }),
          r.memberStates.has(t) ||
            r.memberStates.set(t, { indicatorState: t === e ? 'none' : 'static' }));
        try {
    ...
    if (!t) {
      ...
      if (t.url?.includes('blocked.html'))
        ...
        n &&
          'category0' !== n &&
          ((o = !0),
          r.push({ tabId: e, title: t.title || 'Untitled', url: t.url || '', category: n }));
      }
  ...
  async isTabMcp(e) {
    if (!(!0 === (await chrome.storage.local.get(o.MCP_CONNECTED))[o.MCP_CONNECTED])) return !1;
  ...
  async ensureMcpGroupCharacteristics(e) {
    try {
      ...
      (t.title === z && t.color === chrome.tabGroups.Color.YELLOW) ||
        (await chrome.tabGroups.update(e, { title: z, color: chrome.tabGroups.Color.YELLOW }));
    } catch (t) {}
  }
      ...
      try {
        ...
        if (!l.allowed)
          return l.needsPrompt
            ? { type: 'permission_required', tool: n.NAVIGATE, url: c, toolUseId: u }
        ...
        return { error: `Failed to navigate: ${o instanceof Error ? o.message : 'Unknown error'}` };
      }
    },
...
class te {
  ...
  initializeDebuggerEventListener() {
    te.debuggerListenerRegistered ||
      ((te.debuggerListenerRegistered = !0), this.registerDebuggerEventHandlers());
  }
        ...
        u = await new Promise((e, t) => {
          ...
          ((a.onload = () => {
            ...
            const u = document.createElement('canvas'),
              l = u.getContext('2d');
            if (!l)
              return void t(new Error('Failed to create 2D context for screenshot processing'));
            i > 1
          ...
          if (u.needsPrompt) {
            ...
            if (
              ...
              try {
                ...
                ((t.actionData = {}), o.coordinate && (t.actionData.coordinate = o.coordinate));
              }
            else
        ...
        case 'type':
          c = await (async function (e, t, o) {
            ...
            try {
              ...
              return r || (await re.type(e, t.text), { output: `Typed "${t.text}"` });
            } catch (r) {
              return {
...
const le = {
    ...
    execute: async (e, t) => {
      const { filter: r, tabId: o, depth: i, ref_id: a, max_chars: s } = e || {};
      if (!t?.tabId) throw new Error('No active tab found');
      ...
      if (!h.allowed) {
        if (h.needsPrompt) {
          return { type: 'permission_required', tool: n.READ_PAGE_CONTENT, url: l, toolUseId: d };
        }
        return { error: 'Permission denied for reading pages on this domain' };
      }
      (await K.hideIndicatorForToolUse(c), await new Promise((e) => setTimeout(e, 50)));
      try {
  ...
  he = {
    ...
    execute: async (e, t) => {
      ...
      if (!c.allowed) {
        if (c.needsPrompt) {
          return { type: 'permission_required', tool: n.READ_PAGE_CONTENT, url: a, toolUseId: s };
        }
        return { error: 'Permission denied for reading page content on this domain' };
      }
      (await K.hideIndicatorForToolUse(i), await new Promise((e) => setTimeout(e, 50)));
      try {
        const e = await chrome.scripting.executeScript({
          target: { tabId: i },
          func: (e) =>
  ...
  pe = {
    ...
    execute: async (e, t) => {
      try {
        ...
        if (!t?.tabId) throw new Error('No active tab found');
        const i = await K.getEffectiveTabId(o, t.tabId),
          a = await chrome.tabs.get(i);
        if (!a.id) throw new Error('Active tab has no ID');
        const s = a.url;
        ...
        if (!u.allowed) {
          if (u.needsPrompt) {
            return { type: 'permission_required', tool: n.READ_PAGE_CONTENT, url: s, toolUseId: c };
          }
          return { error: 'Permission denied for reading pages on this domain' };
        }
        ...
        const I = b
          ...
          .join('\n');
        b.length;
        const T = await K.getValidTabsWithMetadata(t.tabId);
        return {
          output: `${v}\n\n${I}`,
          tabContext: {
            currentTabId: t.tabId,
  ...
  const { approved: r, filtered: o } = await (async function (e) {
    ...
    for (const n of e)
      try {
        ...
        !o || ('category1' !== o && 'category2' !== o && 'category_org_blocked' !== o)
          ? t.push(n)
          : r.push(n);
      } catch (o) {
        t.push(n);
...
const Ie = {
    ...
    setPromptsConfig(e) {
      if (
        (e.toolDescription && (this.description = e.toolDescription), e.inputPropertyDescriptions)
      ) {
    ...
    execute: async (e, t) => {
      try {
        ...
        const p = await chrome.scripting.executeScript({
            ...
            try {
              ...
              if (t) {
                ...
                if ('IFRAME' === n.tagName)
                  try {
                    const e = n,
                      r = e.contentDocument || (e.contentWindow ? e.contentWindow.document : null);
                    if (r) {
          ...
          args: [r.ref || null, r.coordinate || null, d, r.filename || 'image.png'],
        });
  ...
  ke = {
    ...
    execute: async (e, t) => {
      try {
        const { tabId: o, onlyErrors: i = !1, clear: a = !1, pattern: s, limit: c = 100 } = e;
        if (!t?.tabId) throw new Error('No active tab found');
...
function $e(e, t, r, o, i) {
  return {
    ...
    actionData: { fromDomain: e, toDomain: t, sourceTabId: o, isSecondaryTab: i },
  };
}
let Le = null;
async function Ne() {
  const e = a(),
    t = await r(),
    o = await fetch(`${e.apiBaseUrl}/api/bootstrap/features/claude_in_chrome`, {
      headers: {
        ...(t ? { Authorization: `Bearer ${t}` } : {}),
        'Content-Type': 'application/json',
      },
    });
  if (!o.ok) throw new Error(`Failed to fetch features: ${o.status}`);
  return o.json();
}
async function qe(e) {
  const t = (Le || (Le = new i({ fetchFeatures: Ne })), Le);
  await t.initialize();
...
async function Fe(e) {
  ...
  return (
    ...
    })({ tabId: t, prompt: r, taskName: n, runLogId: u, sessionId: s, isScheduledTask: !1 }),
    { success: !0 }
  );
}
const We = [
    ...
    me,
    {
      ...
      execute: async (e) => {
        try {
          ...
          if (!r)
            return { output: 'No MCP tab groups found. Use createIfEmpty: true to create one.' };
...
class ze {
  ...
  async handleToolCall(e, t, r, o, n, i) {
    ...
    return await I(
      ...
      async (i) => {
        if (!this.context.tabId && !je.includes(e)) throw new Error('No tab available');
  ...
  createAnthropicMessage() {
    if (this.context.anthropicClient || this.context.refreshClient)
      return async (e) => {
        ...
        if ('small_fast' === t) {
          const e = await qe('chrome_ext_models');
...
var Je = 'is not a string',
  Xe = 'is not an object',
  Qe = 'is nil';
function Ze(e) {
  (!(function (e) {
    if (!Ye(e)) throw new He('Event', Qe);
    if ('object' != typeof e) throw new He('Event', Xe);
  })(e),
    (function (e) {
      if (!Ke(e.type)) throw new He('.type', Je);
    })(e),
    'track' === e.type &&
      ((function (e) {
        if (!Ke(e.event)) throw new He('.event', Je);
      })(e),
      (function (e) {
        if (!Ve(e.properties)) throw new He('.properties', Xe);
      })(e)),
    ['group', 'identify'].includes(e.type) &&
      (function (e) {
        if (!Ve(e.traits)) throw new He('.traits', Xe);
      })(e),
    (function (e) {
      var t,
        r,
        ...
        a =
          null !==
            ...
            ? n
            : t.previousId;
      if (!Ye(a)) throw new He(i, Qe);
      if (!Ke(a)) throw new He(i, Je);
    })(e));
}
var et = (function () {
  function e(e) {
  ...
  return (
    ...
    (e.prototype.page = function (e, t, r, o, n) {
      var i,
        a = { type: 'page', properties: l({}, r), options: l({}, o), integrations: l({}, n) };
      return (
        null !== e &&
          ((a.category = e),
        ...
        null !== t && (a.name = t),
        this.normalize(l(l({}, this.baseEvent()), a))
      );
    }),
    (e.prototype.screen = function (e, t, r, o, n) {
      var i = { type: 'screen', properties: l({}, r), options: l({}, o), integrations: l({}, n) };
      return (
        null !== e && (i.category = e),
        null !== t && (i.name = t),
        this.normalize(l(l({}, this.baseEvent()), i))
      );
    }),
    ...
    (e.prototype.alias = function (e, t, r, o) {
      var n = { userId: e, type: 'alias', options: l({}, r), integrations: l({}, o) };
      return (
        null !== t && (n.previousId = t),
        void 0 === e
          ? this.normalize(l(l({}, n), this.baseEvent()))
          : this.normalize(l(l({}, this.baseEvent()), n))
      );
    }),
    ...
    (e.prototype.context = function (e) {
      ...
      return (
        o.forEach(function (t) {
          'context' !== t && (r.includes(t) ? d(i, t, e[t]) : d(n, t, e[t]));
        }),
        [n, i]
      );
    }),
    (e.prototype.normalize = function (e) {
      var t,
        ...
        o,
        n,
        i = Object.keys(null !== (t = e.integrations) && void 0 !== t ? t : {}).reduce(function (
          t,
          r
        ) {
          var o, n;
          return l(
            l({}, t),
            (((o = {})[r] = Boolean(null === (n = e.integrations) || void 0 === n ? void 0 : n[r])),
            o)
          );
        }, {});
      e.options =
      ...
      var a = l(l({}, i), null === (r = e.options) || void 0 === r ? void 0 : r.integrations),
        s = e.options ? this.context(e.options) : [],
        c = s[0],
        u = s[1];
      e.options;
      var d = h(e, ['options']),
        p = l(l(l({ timestamp: new Date() }, d), { integrations: a, context: c }), u),
        f = l(l({}, p), { messageId: this.createMessageId() });
      return (Ze(f), f);
    }),
    e
  );
...
var ot = (function () {
  ...
  return (
    (e.prototype.warnIfPossibleMemoryLeak = function (e) {
      this.warned ||
        (this.maxListeners && this.callbacks[e].length > this.maxListeners && (this.warned = !0));
    }),
        ...
        if (this.logs.length > 1) {
          var e = this._logs.reduce(function (e, t) {
            var r,
              o,
              n,
              i = l(l({}, t), { json: JSON.stringify(t.extras, null, ' '), extras: t.extras });
            delete i.time;
            var a =
  ...
  lt = (function () {
    ...
    return (
      ...
      (e.prototype.cancel = function (e) {
        if (e) throw e;
        throw new ut({ reason: 'Context Cancel' });
      }),
      (e.prototype.log = function (e, t, r) {
...
function dt(e, t) {
  ...
  return void 0 === o
    ...
    : (function (e) {
        ...
        .catch(function (r) {
          if (r instanceof ut && 'middleware_cancellation' === r.type) throw r;
...
var pt = (function (e) {
  ...
  return (
    ...
    (t.prototype.enqueuRetry = function (e, t) {
      return !(e instanceof ut && !e.retry) && this.queue.pushWithBackoff(t);
    }),
    (t.prototype.flush = function () {
      return m(this, void 0, void 0, function () {
        var e, t;
    ...
    (t.prototype.availableExtensions = function (e) {
      var t,
        ...
        n =
          ...
          o.forEach(function (e) {
            ...
            void 0 !== (n = 'string' != typeof i ? JSON.stringify(i) : i) &&
              (r[n] = f(f([], null !== (o = r[n]) && void 0 !== o ? o : [], !0), [e], !1));
          }),
          r),
        i = n.before,
        a = void 0 === i ? [] : i,
        ...
        l = void 0 === u ? [] : u,
        d = n.after;
      return { before: a, enrichment: c, destinations: l, after: void 0 === d ? [] : d };
    }),
    (t.prototype.flushOne = function (e) {
      var t, r;
      return m(this, void 0, void 0, function () {
        var o, n, i, a, s, c, u, l, d, h, p, f, m, b;
          ...
          switch (g.label) {
            case 0:
              ...
              (e.attempts > 1 && this.emit('delivery_retry', e),
                ...
                (g.label = 1));
            case 1:
              return a < s.length ? ((c = s[a]), [4, ht(e, c)]) : [3, 4];
            case 2:
              ((h = g.sent()) instanceof lt && (e = h),
            ...
            case 4:
              ((u = 0), (l = i), (g.label = 5));
            case 5:
              return u < l.length ? ((d = l[u]), [4, dt(e, d)]) : [3, 8];
            case 6:
              ((h = g.sent()) instanceof lt && (e = h),
...
class wt {
  constructor(
    ...
    ((this._emitter = u),
      ...
      (this._auth = ((l = `${i}:`), A.Buffer.from(l).toString('base64'))),
  ...
  flush(e) {
    ...
    this._batch.length === e && (this.send(this._batch).catch(bt), this.clearBatch());
  }
  enqueue(e) {
    ...
    if (t.tryAdd(n).success) {
      ...
      return ((t.length === this._flushAt || e) && (this.send(t).catch(bt), this.clearBatch()), r);
    }
    t.length && (this.send(t).catch(bt), this.clearBatch());
    const i = this.createBatch(),
      a = i.tryAdd(n);
    if (a.success) {
      return (
        i.length === this._flushPendingItemsCount && (this.send(i).catch(bt), this.clearBatch()),
        r
      );
    }
  ...
  async send(e) {
    ...
    for (; o < r; ) {
      ...
      try {
        ...
        if (400 === o.status) return void yt(e, new Error(`[${o.status}] ${o.statusText}`));
        i = new Error(`[${o.status}] ${o.statusText}`);
      } catch (n) {
        i = n;
      }
      if (o === r) return void yt(e, i);
      await gt(nt({ attempt: o, minTimeout: 25, maxTimeout: 1e3 }));
    }
  }
}
function yt(e, t) {
...
var vt = {};
const It = () =>
  'object' == typeof process && process && vt && 'string' == typeof process.version
    ? 'node'
    ...
    return (
      (function (e) {
        (e.updateEvent('context.library.name', '@segment/analytics-node'),
          e.updateEvent('context.library.version', ft));
        const t = It();
...
class Mt {
  constructor() {
    ((this.onabort = null), (this.aborted = !1), (this.eventEmitter = new ot()));
  }
  toString() {
...
const Rt = async (...e) => {
  ...
  if ('string' != typeof EdgeRuntime)
    return (
      await b(
        async () => {
          const { default: e } = await import('./index-D74dnORg.js');
          return { default: e };
        },
...
class Ut {
  ...
  async makeRequest(e) {
    const [t, r] = ((e) => {
        if ('cloudflare-worker' === It()) return [];
        const t = new (globalThis.AbortController || Dt)(),
          r = setTimeout(() => {
            t.abort();
          }, e);
...
class Pt extends Ct {
  constructor(e) {
    (super(),
      ...
      (this._isFlushing = !1),
      ((e) => {
        if (!e.writeKey) throw new He('writeKey', 'writeKey is missing.');
      })(e),
      (this._eventFactory = new _t()),
      (this._queue = new At()));
    const t = e.flushInterval ?? 1e4;
    this._closeAndFlushDefaultTimeout = 1.25 * t;
    const { plugin: r, publisher: o } = ((e, t) => {
      const r = new wt(e, t);
      return { publisher: r, plugin: Tt(r) };
    })(
      {
        writeKey: e.writeKey,
        host: e.host,
        ...
        flushInterval: t,
        httpClient:
          'function' == typeof e.httpClient ? new Ut(e.httpClient) : (e.httpClient ?? new Ut()),
      },
      this
    );
    ((this._publisher = o),
      ...
      (function (e) {
        for (
          var t = e.constructor.prototype, r = 0, o = Object.getOwnPropertyNames(t);
          r < o.length;
          r++
        ) {
          var n = o[r];
  ...
  async flush({ timeout: e, close: t = !1 } = {}) {
    ...
    return e ? tt(r, e).catch(() => {}) : r;
  }
  _dispatch(e, t) {
    this._isClosed
      ? this.emit('call_after_close', e)
      : (this._pendingEvents++,
        xt(e, this._queue, this, t)
          .catch((e) => e)
          .finally(() => {
  ...
  identify(
    { userId: e, anonymousId: t, traits: r = {}, context: o, timestamp: n, integrations: i },
    a
  ) {
      ...
      try {
        const e = await (async () => {
            try {
              const e = await r();
              if (!e) return null;
              const t = `${a().apiBaseUrl}/api/oauth/profile`,
                o = await fetch(t, {
        ...
        e
          ? ((Ot = e.account.uuid),
            Gt.identify({ userId: Ot, anonymousId: t, traits: { ...y(e), extensionVersion: o } }))
          : (Ot = null);
      } catch (e) {}
  },
  qt = async (e, t = {}) => {
    try {
      if ((Gt || (await Lt()), !Gt)) return;
      const r = await w(),
        o = chrome.runtime.getManifest().version,
        n = { anonymousId: r, event: e, properties: { ...t, extension_version: o } };
      (Ot && (n.userId = Ot), Gt.track(n));
    } catch (r) {}
  };
let Ft, Wt, jt, zt, Ht, Kt;
async function Yt() {
  const [e, t] = await Promise.all([v(o.SELECTED_MODEL), qe('chrome_ext_models')]);
  return e || t?.default || 'claude-3-5-sonnet-20241022';
}
async function Vt(e, t) {
  if (zt) return ((zt.context.tabId = e), (zt.context.tabGroupId = t), zt);
  const [r, o] = await Promise.all([Jt(), Yt()]);
  return (
    (zt = new ze({
      anthropicClient: r,
      ...
      tabGroupId: t,
      model: o,
      onPermissionRequired: async (e, t) => await ar(e, t),
      refreshClient: Jt,
    })),
    zt
  );
...
async function Jt() {
  const [e, { anthropicApiKey: o }] = await Promise.all([
      r(),
      chrome.storage.local.get('anthropicApiKey'),
    ]),
    n = o || void 0;
  if (((Wt !== e || jt !== n) && ((Ft = void 0), (Wt = e), (jt = n)), Ft)) return Ft;
  if (!e && !n) return;
  const i = a();
  return (
    (Ft = new t({
...
async function Qt(e) {
  ...
  if (Ht && Kt) {
    if (Date.now() - Kt < 6e4) {
      ...
      return (
        (Ht = void 0),
        (Kt = void 0),
        qt('claude_chrome.mcp.tool_called', {
  ...
  try {
    ...
    return (
      ...
      Xt('No tabs available. Please open a new tab or window in Chrome.')
    );
  }
  if (void 0 !== i)
    try {
      const e = await re.isDebuggerAttached(i);
      (await re.attachDebugger(i), e || (await new Promise((e) => setTimeout(e, 500))));
    } catch (l) {}
  let c,
    u = !1;
  try {
    void 0 !== i &&
      (await (async function (e, t, r, o) {
        if (
          (Zt.set(e, { toolName: t, requestId: r, startTime: Date.now(), errorCallback: o }),
          await K.addTabToIndicatorGroup({ tabId: e, isRunning: !0, isMcp: !0 }),
          er.has(e))
        ) {
          const t = er.get(e);
          (t && clearTimeout(t), K.addLoadingPrefix(e).catch(() => {}), er.set(e, null));
    ...
    ((u = !0),
      ...
      (l.message.includes('401') ||
        ...
        l.message.includes('invalid x-api-key'))
        ? ((Ft = void 0),
          (Wt = void 0),
          (jt = void 0),
        ...
        : ((c = 'execution_error'), (s = Xt(l instanceof Error ? l.message : String(l)))));
  }
  return (
    void 0 !== i && rr(i, r),
    qt('claude_chrome.mcp.tool_called', {
  ...
  const r = ir.then(() =>
    (async function (e, t) {
      ...
      return (
        ...
        qt('claude_chrome.permission.prompted', {
        ...
        new Promise((n) => {
          ...
          const s = async (s = !1) => {
              a ||
                ...
                qt('claude_chrome.permission.responded', {
                  permission_type: e.type,
                  tool_type: e.tool,
                  tab_id: t,
                  allowed: s,
