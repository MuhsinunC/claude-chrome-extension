...
import { r as d, j as c, S as x, R as m, n as h, o as u } from './permissions-BsMI2TUG.js';
import { P as g, i as f, a as p } from './SentryService-Bpayo6Ny.js';
import { u as b, X as j, m as v, i as w } from './datadog-BkLmkJ5p.js';
import { T as N } from './TasksTab-Bu17Fa0S.js';
/**
 ...
 */ const M = e('log-out', [
    ...
    return c.jsxs('div', {
      ...
      children: [
        c.jsx('h3', {
          ...
          children: c.jsx(t, { defaultMessage: 'Microphone', id: 'cW6887Dc/X' }),
        }),
        c.jsx('p', {
              ...
              c.jsxs('div', {
                children: [
                  c.jsx('button', {
                    onClick: async () => {
                      ...
                      try {
                        ((await navigator.mediaDevices.getUserMedia({ audio: !0 }))
                          ...
                          .forEach((e) => e.stop()),
                          await m(),
                          e?.track('claude_chrome.settings.microphone_enabled', {
                            timestamp: Date.now(),
                          }));
                      } catch (s) {
                        (s instanceof DOMException
                          ? 'NotAllowedError' === s.name
                            ...
                            : 'NotFoundError' === s.name
                              ...
                              : x(
                                  a.formatMessage(
                                    { defaultMessage: 'Error: {errorMessage}', id: 'Q+J7H4sPgD' },
                    ...
                    children: i
                      ? c.jsx(t, { defaultMessage: 'Requesting...', id: 'Gma+ACm5J+' })
                      : c.jsx(t, { defaultMessage: 'Allow Microphone Access', id: 'JfUPjhqwuq' }),
                  }),
                  l &&
                    c.jsx('div', {
                      className:
                        'mt-3 px-4 py-3 bg-danger-000/10 border border-danger-000/20 rounded-lg',
                      children: c.jsx('p', { className: 'font-base text-danger-000', children: l }),
                    }),
                ],
              }),
            'granted' === n &&
                ...
                children: [
                  c.jsx('div', {
                    ...
                    children: c.jsx('svg', {
                      ...
                      viewBox: '0 0 24 24',
                      stroke: 'currentColor',
                      children: c.jsx('path', { d: 'M5 13l4 4L19 7' }),
                    }),
                  }),
                  c.jsxs('div', {
                    children: [
                      ...
                      c.jsx('div', {
                        ...
                        children: c.jsx(t, {
                          ...
                          id: 'NSJdoMrS0C',
                          values: {
                            chromeSettingsLink: c.jsx('button', {
                              onClick: h,
                ...
                children: [
                  c.jsx('div', {
                    ...
                    children: c.jsx('svg', {
                      ...
                      viewBox: '0 0 24 24',
                      stroke: 'currentColor',
                      children: c.jsx('path', { d: 'M6 18L18 6M6 6l12 12' }),
                    }),
                  }),
                  c.jsxs('div', {
                    children: [
  ...
  S = () => {
    const e = s(),
      [n, r] = d.useState(),
      [i, o] = d.useState(!0),
      [l, m] = b(x.NOTIFICATIONS_ENABLED, void 0),
      { analytics: h } = a(),
      u = d.useMemo(() => new g(() => !1), []),
    ...
    const p = async (e) => {
        (await u.revokePermission(e), f());
      },
      j = (s) =>
        'domain_transition' === s.scope.type
          ? `${s.scope.fromDomain} → ${s.scope.toDomain}`
          : s.scope.netloc ||
            e.formatMessage({ defaultMessage: 'Unknown domain', id: 'FMvJL9TokP' });
    return i
      ? c.jsx('div', {
          className: 'p-6 text-text-200',
          children: c.jsx(t, { defaultMessage: 'Loading permissions...', id: '481hO7jC9z' }),
        })
      : c.jsx('div', {
            ...
            children: [
              c.jsxs('div', {
                ...
                children: [
                  c.jsx('h3', {
                    className: 'text-text-100 font-xl-bold',
                    children: c.jsx(t, { defaultMessage: 'Notifications', id: 'NAidKbB0vi' }),
                  }),
                  c.jsx('p', {
                    className: 'text-text-300 font-base mt-2 mb-6',
                    children: c.jsx(t, {
              ...
              c.jsxs('div', {
                ...
                children: [
                  c.jsx('h3', {
                    className: 'text-text-100 font-xl-bold',
                    children: c.jsx(t, { defaultMessage: 'Your approved sites', id: 'NFf/0A3zf+' }),
                  }),
                  c.jsx('p', {
                    className: 'text-text-300 font-base mt-2 mb-6',
                    children: c.jsx(t, {
                  ...
                  n?.netloc && n.netloc.length > 0
                    ? c.jsx(C, { permissions: n.netloc, onRevoke: p, formatScope: j })
                    : c.jsx('div', {
              ...
              n?.domain_transition &&
                ...
                c.jsxs('div', {
                  ...
                  children: [
                    ...
                    c.jsx(E, { permissions: n.domain_transition, onRevoke: p, formatScope: j }),
                  ],
                }),
            ],
          }),
  ...
  C = ({ permissions: e, onRevoke: s, formatScope: a }) =>
    c.jsx('div', {
      children: e.map((n, r) =>
        c.jsxs(
          m.Fragment,
              ...
              c.jsxs('div', {
                ...
                children: [
                  c.jsxs('div', {
                    className: 'flex-1',
                    children: [
                      c.jsx('div', { className: 'font-large text-text-100', children: a(n) }),
                      n.lastUsed &&
                        c.jsx('div', {
                          ...
                          children: c.jsx(t, {
                            ...
                            id: 'VbVJvDFrU4',
                            values: { date: new Date(n.lastUsed).toLocaleString() },
                          }),
                        }),
                    ],
                  }),
                  c.jsx('button', {
                    ...
                    children: c.jsx(t, { defaultMessage: 'Revoke', id: 'tnRDuUFRQw' }),
                  }),
                ],
              }),
              r < e.length - 1 && c.jsx('div', { className: 'border-b border-border-400' }),
            ],
          },
          n.id
        )
  ...
  E = ({ permissions: e, onRevoke: s, formatScope: a }) =>
    c.jsx('div', {
      children: e.map((n, r) =>
        c.jsxs(
          m.Fragment,
  ...
  A = ({ isOpen: e, returnTabId: a, onClose: n }) => {
    const r = s(),
      [i, o] = d.useState('unknown'),
      [l, x] = d.useState(!1),
      [m, h] = d.useState(null),
      [u, g] = d.useState(!1),
      f = d.useCallback(() => {
              ...
              c.jsxs('div', {
                ...
                children: [
                  ...
                  c.jsx('button', {
                    ...
                    'aria-label': r.formatMessage({ defaultMessage: 'Close', id: 'rbrahOGMC3' }),
                    children: c.jsx(j, { size: 16, className: 'text-text-300' }),
                  }),
                ],
              }),
              c.jsxs('div', {
                ...
                children: [
                  ...
                  c.jsx('p', {
                    ...
                    children: c.jsx(t, {
                      ...
                      values: {
                        strong: (e) =>
                          c.jsx('span', { className: 'font-semibold text-text-200', children: e }),
                      },
                    }),
                  }),
                  'granted' === i
                  ...
                  m &&
                    c.jsx('div', {
                      ...
                      children: c.jsx('p', { className: 'font-base text-danger-000', children: m }),
                    }),
                  'granted' !== i &&
                    'denied' !== i &&
                    c.jsxs('button', {
                      ...
                      children: [
                        c.jsx(v, { size: 20, weight: 'fill' }),
                        l
                          ? c.jsx(t, { defaultMessage: 'Requesting access...', id: 'kDYzre2KOj' })
                          : c.jsx(t, {
                  ...
                  c.jsx('button', {
                    ...
                    children: c.jsx(t, { defaultMessage: 'Skip for now', id: 'WYzHAIKZxl' }),
                  }),
                ],
              }),
            ],
  ...
  P = ({ children: e, isActive: s, onClick: t }) =>
    c.jsx('button', {
      onClick: t,
      className: n(
  ...
  D = ({ children: e, className: s, narrow: t }) =>
    c.jsx('main', {
      className: n(
          ...
          ? c.jsxs(c.Fragment, {
              children: [
                c.jsx('h1', {
                  ...
                  children: c.jsx('span', { className: 'truncate', children: i }),
                }),
                c.jsx('div', {}),
                e,
              ],
...
function R() {
  const { userProfile: e, isAuthenticated: s } = r(),
    { resetAnalytics: n } = a(),
    o = !1,
    [l, m] = d.useState(''),
    [g, f] = d.useState(!1),
    [p, b] = d.useState('permissions'),
    [j, v] = d.useState(''),
    [w, k] = d.useState(!1),
    [C, E] = d.useState(!1),
    [R, T] = d.useState();
  ...
  return c.jsxs('div', {
    ...
    children: [
        ...
        children: [
          s &&
            ...
            c.jsxs('div', {
              ...
              children: [
                c.jsx(y, { className: 'w-4 h-4 text-text-300' }),
                c.jsx('span', {
              ...
              children: [
                c.jsxs('div', {
                  ...
                  children: [
                    ...
                    c.jsx('span', {
                      className: 'font-base-sm text-text-200',
                      children: c.jsx(t, { defaultMessage: 'API Key Mode', id: '5oZeuus9Dz' }),
                    }),
                  ],
                }),
                c.jsx('button', {
                  ...
                  children: c.jsx(t, { defaultMessage: 'Login', id: 'AyGauyc55S' }),
                }),
              ],
            }),
        ],
                  ...
                  c.jsxs('nav', {
                    ...
                    children: [
                      ...
                      s &&
                        c.jsx(c.Fragment, {
                          children: c.jsx('div', {
                            className: 'mt-8 pt-8 border-t-[0.5px] border-border-300',
                            children: c.jsxs('button', {
                              ...
                              children: [
                                ...
                                c.jsx(t, { defaultMessage: 'Log out', id: 'PlBReUqqzW' }),
                              ],
                            }),
                          }),
                        }),
      ...
      c.jsx(A, { isOpen: C, returnTabId: R, onClose: () => E(!1) }),
    ],
  });
}
(f(),
  ...
  o
    ...
    .render(
      c.jsx(m.StrictMode, { children: c.jsx(l, { pageName: 'Options', children: c.jsx(R, {}) }) })
    ));
