...
function f(t, e, n, r) {
  ...
  return (
    (s[t] = e),
    n.debug('@opentelemetry/api: Registered a global for ' + t + ' v' + u + '.'),
    !0
  );
}
function g(t) {
    ...
    function t() {
      ...
      ((e.setLogger = function (t, n) {
        ...
        if ((void 0 === n && (n = { logLevel: v.INFO }), t === e)) {
          ...
          return (e.error(null !== (r = o.stack) && void 0 !== r ? r : o.message), !1);
        }
...
var Q,
  ...
  st = (function () {
    ...
    return (
      ...
      (t.prototype.with = function (t, e, n) {
        for (var r, i = [], s = 3; s < arguments.length; s++) i[s - 3] = arguments[s];
...
(((Z = Q || (Q = {}))[(Z.NONE = 0)] = 'NONE'), (Z[(Z.SAMPLED = 1)] = 'SAMPLED'));
  ...
  xt = (function () {
    ...
    return (
      (t.prototype.startSpan = function (t, e, n) {
        if ((void 0 === n && (n = St.active()), Boolean(null == e ? void 0 : e.root)))
          return new ut();
        var r,
          i = n && gt(n);
...
const ie = class t {
  ...
  getLoggerProvider() {
    var t, e;
    return null !== (e = null === (t = re[ne]) || void 0 === t ? void 0 : t.call(re, 1)) &&
      void 0 !== e
      ? e
...
const de = (t) => null !== t && 'object' == typeof t && 'function' == typeof t.then;
class he {
  _rawAttributes;
  ...
  get attributes() {
    if (
      (this.asyncAttributesPending &&
        It.error('Accessing resource attributes before async attributes settled'),
      this._memoizedAttributes)
    )
      return this._memoizedAttributes;
    const t = {};
    for (const [e, n] of this._rawAttributes)
      de(n) ? It.debug(`Unsettled resource attribute ${e} skipped`) : null != n && (t[e] ??= n);
  ...
  merge(t) {
    return null == t
      ? this
      : he.FromAttributeList([...t.getRawAttributes(), ...this.getRawAttributes()]);
  }
}
function pe(t) {
...
function fe() {
  return pe({ [se]: 'unknown_service', [oe]: le[oe], [ae]: le[ae], [ce]: le[ce] });
}
function ge(t) {
  return t.map(([t, e]) =>
    de(e)
...
var Ie, De;
(((De = Ie || (Ie = {}))[(De.SUCCESS = 0)] = 'SUCCESS'), (De[(De.FAILED = 1)] = 'FAILED'));
...
function Ke(t, e, n = 0, r) {
  ...
  if (!(n > 20)) {
    if ((n++, Ze(t) || Ze(e) || Je(e))) i = qe(e);
      ...
      if (((i = t.slice()), Ye(e))) for (let t = 0, n = e.length; t < n; t++) i.push(qe(e[t]));
      else if (Qe(e)) {
          ...
          if (Ze(c)) void 0 === c ? delete i[a] : (i[a] = c);
            ...
            if (Xe(t, a, r) || Xe(e, a, r)) delete i[a];
              ...
              if (Qe(s) && Qe(o)) {
                const n = r.get(s) || [],
                  i = r.get(o) || [];
                (n.push({ obj: t, key: a }), i.push({ obj: e, key: a }), r.set(s, n), r.set(o, i));
              }
              i[a] = Ke(i[a], c, n, r);
            }
          }
...
class nn {
  ...
  setAttribute(t, e) {
    ...
    if (!we(e)) return (It.warn(`Invalid attribute value set for key: ${t}`), this);
  ...
  addEvent(t, e, n) {
    ...
    if (0 === r) return (It.warn('No events allowed.'), this._droppedEventsCount++, this);
    (void 0 !== r &&
    ...
    this._isSpanEnded()
      ...
      : ((this._ended = !0),
        ...
        this._droppedEventsCount > 0 &&
          It.warn(`Dropped ${this._droppedEventsCount} events because eventCountLimit reached`),
  ...
  _truncateToSize(t) {
    ...
    return e <= 0
      ...
      : 'string' == typeof t
        ...
        : Array.isArray(t)
          ? t.map((t) => ('string' == typeof t ? this._truncateToLimitUtil(t, e) : t))
          : t;
  }
}
var rn;
...
class an {
  ...
  constructor(t) {
    ((this._root = t.root),
      this._root ||
        (Ee(new Error('ParentBasedSampler must have a root sampler configured')),
        (this._root = new on())),
...
class cn {
  ...
  shouldSample(t, e) {
    return {
      decision:
        bt(e) && this._accumulate(e) < this._upperBound ? rn.RECORD_AND_SAMPLED : rn.NOT_RECORD,
    };
  }
  toString() {
...
class pn {
  ...
  constructor(t, e) {
    ((this._exporter = t),
      ...
      (this._maxQueueSize = 'number' == typeof e?.maxQueueSize ? e.maxQueueSize : 2048),
      (this._scheduledDelayMillis =
        'number' == typeof e?.scheduledDelayMillis ? e.scheduledDelayMillis : 5e3),
      (this._exportTimeoutMillis =
        'number' == typeof e?.exportTimeoutMillis ? e.exportTimeoutMillis : 3e4),
  ...
  _addToBuffer(t) {
    if (this._finishedSpans.length >= this._maxQueueSize)
      return (
        0 === this._droppedSpansCount && It.debug('maxQueueSize reached, dropping spans'),
        void this._droppedSpansCount++
      );
    (this._droppedSpansCount > 0 &&
      (It.warn(`Dropped ${this._droppedSpansCount} spans because maxQueueSize reached`),
      (this._droppedSpansCount = 0)),
  ...
  _flushAll() {
    return new Promise((t, e) => {
      const n = [];
      for (
        let r = 0, i = Math.ceil(this._finishedSpans.length / this._maxExportBatchSize);
        r < i;
        r++
      )
  ...
  _maybeStartTimer() {
    ...
    void 0 === this._timer &&
      ((this._timer = setTimeout(() => t(), this._scheduledDelayMillis)), this._timer);
  }
  _clearTimer() {
...
function _n(t) {
  return function () {
    for (let e = 0; e < 2 * t; e++)
      ((gn[e] = Math.floor(16 * Math.random()) + 48), gn[e] >= 58 && (gn[e] += 39));
...
class vn {
  ...
  startSpan(t, e = {}, n = Nt.active()) {
    ...
    const u = e.kind ?? At.INTERNAL,
      l = (e.links ?? []).map((t) => ({ context: t.context, attributes: be(t.attributes) })),
      d = be(e.attributes),
      ...
      e = this._activeSpanProcessor._spanProcessors.map(
        (e) =>
          new Promise((n) => {
            ...
            e.forceFlush()
              .then(() => {
                (clearTimeout(i), r !== yn.timeout && ((r = yn.resolved), n(r)));
              })
              .catch((t) => {
...
class xn {
  ...
  enable() {
    return (this._enabled || ((this._enabled = !0), (this._currentContext = k)), this);
  }
  with(t, e, n, ...r) {
  ...
  return (
    e.length > 0 &&
      ('string' != typeof (a = e.join(';')) &&
        (T.error('Cannot create baggage metadata from unknown type: ' + typeof a), (a = '')),
      (o = {
        __TYPE__: E,
        toString: function () {
          return a;
  ...
  inject(t, e, n) {
    ...
    const i = (function (t) {
        return t.getAllEntries().map(([t, e]) => {
          ...
          return (void 0 !== e.metadata && (n += ';' + e.metadata.toString()), n);
        });
      })(r)
  ...
  inject(t, e, n) {
    for (const i of this._propagators)
      try {
        ...
        It.warn(`Failed to inject with ${i.constructor.name}. Err: ${r.message}`);
      }
  }
  extract(t, e, n) {
    return this._propagators.reduce((t, r) => {
      try {
        ...
        It.warn(`Failed to extract with ${r.constructor.name}. Err: ${i.message}`);
      }
      return t;
    }, t);
  }
...
const kn = '[_0-9a-z-*/]',
  Ln = new RegExp(`^(?:${`[a-z]${kn}{0,255}`}|${`[a-z0-9]${kn}{0,240}@[a-z]${kn}{0,13}`})$`),
  Mn = /^[ -~]{0,255}[!-~]$/,
  Rn = /,|=/;
class Nn {
    ...
    (Xt.setGlobalTracerProvider(this),
      null !== (e = t.propagator) &&
        (void 0 !== e
          ...
          : qt.setGlobalPropagator(new On({ propagators: [new $n(), new Pn()] }))),
      (function (t) {
        if (null !== t) {
          if (void 0 === t) {
            const t = new xn();
...
const Jn = new (class {
    ...
    _getResourceAttributes(t, e) {
      return t[Yn] || t[Wn]
        ? { attributes: t }
        : (It.debug('BrowserDetector failed: Unable to find required browser resources. '), me());
    }
  })(),
...
function xr(t, e, n = 0, r) {
  ...
  if (!(n > 20)) {
    if ((n++, Pr(t) || Pr(e) || Ar(e))) i = Sr(e);
      ...
      if (((i = t.slice()), Tr(e))) for (let t = 0, n = e.length; t < n; t++) i.push(Sr(e[t]));
      else if (Cr(e)) {
        const t = Object.keys(e);
        for (let n = 0, r = t.length; n < r; n++) {
          const r = t[n];
...
var Dr,
  Ur = (function () {
    ...
    function r(n) {
      n &&
        n.logger &&
        (t(n.logger) ? (e = n.logger) : e("new logger isn't a function, not replacing"));
    }
    function i(r, i, s) {
      if (r && r[i]) {
    ...
    function s(t, n) {
      return t && t[n]
        ? t[n].__unwrap
          ? t[n].__unwrap()
          : void e('no original to unwrap to -- has ' + n + ' already been unwrapped?')
        : (e('no function to unwrap.'), void e(new Error().stack));
    }
    return (
      (r.wrap = i),
      (r.massWrap = function (t, n, r) {
        if (!t) return (e('must provide one or more modules to patch'), void e(new Error().stack));
        (Array.isArray(t) || (t = [t]),
          n && Array.isArray(n)
          ...
          ((e.noConflict = function () {
            ...
            (e.report = (function () {
              ...
              function h(t, r, i, o, a) {
                if (l) (e.computeStackTrace.augmentStackTraceWithInitialElement(l, r, i, t), m());
                  ...
                  ((u.func = e.computeStackTrace.guessFunctionName(u.url, u.line)),
                    ...
                    d({ name: c, message: h, mode: 'onerror', stack: [u] }, !0, null));
                }
              ...
              return (
                (f.subscribe = function (e) {
                  (!0 !== r && ((n = t.onerror), (t.onerror = h), (r = !0)),
                    !0 !== a &&
                      ((i = t.onunhandledrejection), (t.onunhandledrejection = p), (a = !0)),
                    c.push(e));
                }),
                (f.unsubscribe = function (e) {
                  for (var s = c.length - 1; s >= 0; --s) c[s] === e && c.splice(s, 1);
                  0 === c.length &&
                    (r && ((t.onerror = n), (r = !1)),
            ...
            (e.computeStackTrace = (function () {
              ...
              function h(t, e, n) {
                ...
                return ((n -= 1), s && s.length > n && (i = o.exec(s[n])) ? i.index : null);
              }
              function p(e) {
                if (!a(t && t.document)) {
                  for (
                  ...
                  if (
                    ...
                    ((n = u(i[3]).replace(/;$/, ';?')),
                      (r = new RegExp(
                        'function' + f + '\\s*\\(\\s*' + g + '\\s*\\)\\s*{\\s*' + n + '\\s*}'
                      )));
                  } else r = new RegExp(u(h).replace(/\s+/g, '\\s+'));
                  if ((s = d(r, o))) return s;
                  if (
                    (i = /^function on([\w$]+)\s*\(event\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/.exec(h))
                  ) {
                    var _ = i[1];
                    if (
                      ((n = l(i[2])),
                      (s = d(
                        (r = new RegExp('on' + _ + '=[\\\'"]\\s*' + n + '\\s*[\\\'"]', 'i')),
                        o[0]
                      )))
                    )
                      return s;
                ...
                for (
                  ...
                  if ((n = o.exec(m[_]))) {
                    ...
                    (n[3] && n[3].indexOf(' > eval') > -1 && (e = d.exec(n[3]))
                      ...
                      : 0 !== _ || n[5] || a(t.columnNumber) || (f[0].column = t.columnNumber + 1),
                      (r = {
                        url: n[3],
                        func: n[1] || i,
                        args: n[2] ? n[2].split(',') : [],
                ...
                if (i.url && i.line) {
                  ...
                  if (
                    ...
                    if (!t.stack[0].line && t.stack[0].func === i.func)
                      return ((t.stack[0].line = i.line), (t.stack[0].context = i.context), !1);
                  }
              ...
              function g(t, n) {
                for (
                  ...
                  if (m !== _ && m !== e.report) {
                    if (
                      ((o = { url: null, func: i, args: [], line: null, column: null }),
                      m.name ? (o.func = m.name) : (r = c.exec(m.toString())) && (o.func = r[1]),
                      void 0 === o.func)
                    )
                      try {
                ...
                n && u.splice(0, n);
                var b = { mode: 'callers', name: t.name, message: t.message, stack: u };
                return (
                  f(
                    b,
                      ...
                      if (e) {
                        for (
                          ...
                          if (
                            ...
                            if ((!l.func && l.line && (l.func = s(l.url, l.line)), l.line))
                              try {
                        ...
                        return a.length
                          ? { mode: 'stacktrace', name: t.name, message: t.message, stack: a }
                          : null;
                      }
                    })(e)),
                    i)
                  ...
                  if (
                    ((i = (function (e) {
                      ...
                      var i,
                        ...
                        p = [],
                        m = t && t.document && t.document.getElementsByTagName('script'),
                        f = [];
                      for (var g in m) o(m, g) && !m[g].src && f.push(m[g]);
                      for (var _ = 2; _ < n.length; _ += 2) {
                        var v = null;
                        if ((i = a.exec(n[_])))
                          v = { url: i[2], func: i[3], args: [], line: +i[1], column: null };
                        else if ((i = u.exec(n[_]))) {
                          v = { url: i[3], func: i[4], args: [], line: +i[1], column: null };
                          var b = +i[1],
                            y = f[i[2] - 1];
                          if (y) {
                            var w = r(v.url);
                      ...
                      return p.length
                        ? { mode: 'multiline', name: e.name, message: n[0], stack: p }
                        : null;
                    })(e)),
                    i)
                  )
            ...
            jr.exports && t.module !== jr ? (jr.exports = e) : (t.TraceKit = e));
        }
        function o(t, e) {
  ...
  return {
    handleResponse(t) {
      null != t &&
        ...
        It.warn('Received Partial Success response:', JSON.stringify(t.partialSuccess));
    },
  };
}
!(function (t) {
...
class Yr {
  ...
  constructor(t, e, n, r, i) {
    ((this._transport = t),
      ...
      (this._timeout = i),
      (this._diagLogger = It.createComponentLogger({ namespace: 'OTLPExportDelegate' })));
  }
  export(t, e) {
    if ((this._diagLogger.debug('items to be sent', t), this._promiseQueue.hasReachedLimit()))
      return void e({ code: Br.FAILED, error: new Error('Concurrent export limit reached') });
            ...
            (t) => {
              if ('success' !== t.status)
                'failure' === t.status && t.error
                  ...
                  : 'retryable' === t.status
                    ? e({ code: Br.FAILED, error: new zr('Export failed with retryable status') })
                    : e({ code: Br.FAILED, error: new zr('Export failed with unknown error') });
              else {
                if (null != t.data)
                  try {
...
function ni(t) {
  ...
  return (
    (n = e),
    { low: Number(BigInt.asUintN(32, n)), high: Number(BigInt.asUintN(32, n >> BigInt(32))) }
  );
  var n;
}
const ri =
...
const oi = { encodeHrTime: ni, encodeSpanContext: ti, encodeOptionalSpanContext: si };
function ai(t) {
      ...
      : 'boolean' === e
        ...
        : t instanceof Uint8Array
          ...
          : Array.isArray(t)
            ...
            : 'object' === e && null != t
              ? { kvlistValue: { values: Object.entries(t).map(([t, e]) => di(t, e)) } }
              : {};
}
function pi(t, e) {
  const n = (function (t) {
        ...
        (function (t, e) {
          ...
          switch (t.dataPointType) {
            ...
            case bi.EXPONENTIAL_HISTOGRAM:
              n.exponentialHistogram = { aggregationTemporality: r, dataPoints: Pi(t, e) };
          }
          return n;
        })(t, e)
      ),
...
function Oi(t, e) {
  return {
    resourceMetrics: t.map((t) =>
      (function (t, e) {
        const n = ai(e);
        return { resource: ci(t.resource), schemaUrl: void 0, scopeMetrics: Ti(t.scopeMetrics, n) };
      })(t, e)
    ),
  };
}
...
(((gi = fi || (fi = {}))[(gi.DELTA = 0)] = 'DELTA'),
  ...
  (Ei[(Ei.AGGREGATION_TEMPORALITY_DELTA = 1)] = 'AGGREGATION_TEMPORALITY_DELTA'),
  (Ei[(Ei.AGGREGATION_TEMPORALITY_CUMULATIVE = 2)] = 'AGGREGATION_TEMPORALITY_CUMULATIVE'));
const Mi = {
    serializeRequest: (t) => {
        ...
        (r.onreadystatechange = () => {
          ...
          r.status >= 200 && r.status <= 299
            ...
            : r.status && ((t = r.status), [429, 502, 503, 504].includes(t))
              ? n({ status: 'retryable', retryInMillis: $i(r.getResponseHeader('Retry-After')) })
              : 0 !== r.status &&
                n({
                  status: 'failure',
...
class Bi {
  ...
  send(t) {
    return new Promise((e) => {
      navigator.sendBeacon(this._params.url, new Blob([t], { type: this._params.blobType }))
        ...
        () => {
          ...
          return (
            Object.entries(o?.() ?? {}).forEach(([e, n]) => {
              void 0 !== n
                ? (t[e] = String(n))
                : It.warn(`Header "${e}" has invalid value (${n}) and will be ignored`);
            }),
            t
          );
        }),
  ...
  return i
    ...
    : (function (t, e) {
        return Jr(
          ...
          e,
          Ui({
            transport: ((n = { url: t.url, blobType: t.headers()['Content-Type'] }), new Bi(n)),
          })
        );
        var n;
      })(s, e);
...
class ts extends Zi {
  constructor(t) {
    super(Vi(t ?? {}, Ri, 'v1/metrics', { 'Content-Type': 'application/json' }), t);
  }
}
class es extends Gr {
  constructor(t = {}) {
    ...
    (function (t, e) {
      !(function (n, r) {
        var i = 'function',
          ...
          W = function (t, e) {
            if (typeof t === a)
              return ((t = t.replace(/^\s\s*/, '')), typeof e === s ? t : t.substring(0, 500));
          },
          q = function (t, e) {
          ...
          K = function (t, e) {
            for (var n in e)
              if (typeof e[n] === o && e[n].length > 0) {
                for (var i = 0; i < e[n].length; i++) if (V(e[n][i], t)) return '?' === n ? r : n;
          ...
          Y = {
            ...
            device: [
              ...
              [u, [h, 'TCL'], [d, _]],
              [/(itel) ((\w+))/i],
              [[h, H], u, [d, K, { tablet: ['p10001l', 'w7001'], '*': 'mobile' }]],
            ...
            return (
              (this.getBrowser = function () {
                ...
                return (
                  ...
                  w && f && f.brave && typeof f.brave.isBrave == i && (e[l] = 'Brave'),
                  e
                );
              }),
              ...
              (this.getOS = function () {
                ...
                return (
                  ...
                  w &&
                    ...
                    b.platform &&
                    'Unknown' != b.platform &&
                    (t[l] = b.platform.replace(/chrome os/i, B).replace(/macos/i, F)),
                  t
                );
              }),
...
function ms(t) {
  let e = Object.keys(t);
  return 0 === e.length ? '' : ((e = e.sort()), JSON.stringify(e.map((e) => [e, t[e]])));
}
(!(function (t) {
...
class ys {
  ...
  constructor(
    ...
    ((this.startTime = t), (this._boundaries = e), (this._recordMinMax = n), (this._current = r));
  }
  record(t) {
...
class Ss {
  ...
  constructor(t = new xs(), e = 0, n = 0, r = 0) {
    ((this.backing = t), (this.indexBase = e), (this.indexStart = n), (this.indexEnd = r));
  }
  get offset() {
    return this.indexStart;
  }
  get length() {
    return 0 === this.backing.length || (this.indexEnd === this.indexStart && 0 === this.at(0))
      ? 0
  ...
  trim() {
    for (let t = 0; t < this.length; t++) {
      ...
      if (t === this.length - 1) return void (this.indexStart = this.indexEnd = this.indexBase = 0);
    }
  ...
  downscale(t) {
    ...
    for (let s = this.indexStart; s <= this.indexEnd; ) {
      let t = s % n;
      t < 0 && (t += n);
      for (let o = t; o < n && r < e; o++) (this._relocateBucket(i, r), r++, s++);
      i++;
    }
    ((this.indexStart >>= t), (this.indexEnd >>= t), (this.indexBase = this.indexStart));
  }
  clone() {
    return new Ss(this.backing.clone(), this.indexBase, this.indexStart, this.indexEnd);
  }
  _rotate() {
...
class xs {
  ...
  reverse(t, e) {
    ...
    for (let r = 0; r < n; r++) {
      ...
      ((this._counts[t + r] = this._counts[e - r - 1]), (this._counts[e - r - 1] = n));
    }
  }
  emptyBucket(t) {
...
class Ls {
  ...
  lowerBoundary(t) {
    ...
    if (t < e) throw new ks(`underflow: ${t} is < minimum lower boundary: ${e}`);
...
const Rs = Array.from({ length: 31 }, (t, e) => (e > 10 ? new Ms(e - 10) : new Ls(e - 10)));
function Ns(t) {
  if (t > 20 || t < -10) throw new ks(`expected scale >= -10 && <= 20, got: ${t}`);
  return Rs[t + 10];
}
class Is {
  low;
...
class Ds {
  ...
  merge(t) {
    (0 === this._count
      ...
      : 0 !== t.count &&
        (t.min < this.min && (this._min = t.min), t.max > this.max && (this._max = t.max)),
  ...
  _updateBuckets(t, e, n) {
    ...
    if (
      (0 === t.length
        ? ((t.indexStart = r), (t.indexEnd = t.indexStart), (t.indexBase = t.indexStart))
  ...
  _incrementIndexBy(t, e, n) {
    if (0 === n) return;
    if ((0 === t.length && (t.indexStart = t.indexEnd = t.indexBase = e), e < t.indexStart)) {
  ...
  _downscale(t) {
    ...
    (this._positive.downscale(t), this._negative.downscale(t), (this._mapping = Ns(e)));
  }
  _minScale(t) {
  ...
  _mergeBuckets(t, e, n, r) {
    const i = n.offset,
      s = e.scale - r;
    for (let o = 0; o < n.length; o++) this._incrementIndexBy(t, (i + o) >> s, n.at(o));
  }
...
class Bs {
  ...
  constructor(t, e, n = 0, r = !1) {
    ((this.startTime = t), (this.monotonic = e), (this._current = n), (this.reset = r));
  }
  record(t) {
    ...
    _resolve(t) {
      switch (t.type) {
        ...
        case us.OBSERVABLE_GAUGE:
          return Ys;
        case us.HISTOGRAM:
          return t.advice.explicitBucketBoundaries ? new Ws(t.advice.explicitBucketBoundaries) : Js;
      }
...
function to(t) {
  switch (t.type) {
    ...
    case Zs.EXPLICIT_BUCKET_HISTOGRAM: {
      const e = t;
      return null == e.options ? Js : new Ws(e.options?.boundaries, e.options?.recordMinMax);
    }
    default:
...
class ro {
  ...
  constructor(t) {
    ((this._aggregationSelector = t?.aggregationSelector ?? eo),
      (this._aggregationTemporalitySelector = t?.aggregationTemporalitySelector ?? no),
  ...
  async collect(t) {
    ...
    const [e, ...n] = await Promise.all([
        ...
        ...this._metricProducers.map((e) => e.collect({ timeoutMillis: t?.timeoutMillis })),
      ]),
...
class io extends ro {
  ...
  async _doRun() {
    ...
    if (
      (e.length > 0 && It.error('PeriodicExportingMetricReader: metrics collection errors', ...e),
      t.resource.asyncAttributesPending)
    )
      try {
        await t.resource.waitForAsyncAttributes?.();
      } catch (r) {
        (It.debug('Error while resolving async portion of resource: ', r), nr(r));
      }
  ...
  static _sendMetrics(t, e) {
    for (const n of t.scopeMetrics)
      for (const t of n.metrics)
        console.dir(
          { descriptor: t.descriptor, dataPointType: t.dataPointType, dataPoints: t.dataPoints },
          { depth: null }
        );
    e({ code: dr.SUCCESS });
  }
...
class oo {
  ...
  findViews(t, e) {
    return this._registeredViews.filter(
      (n) => this._matchInstrument(n.instrumentSelector, t) && this._matchMeter(n.meterSelector, e)
    );
  }
...
class lo {
  ...
  _record(t, e = {}, n = Nt.active()) {
    'number' == typeof t
      ...
      : It.warn(`non-number value provided to metric ${this._descriptor.name}: ${t}`);
  }
}
class ho extends lo {
  add(t, e, n) {
...
class po extends lo {
  add(t, e, n) {
    t < 0
      ? It.warn(`negative value provided to counter ${this._descriptor.name}: ${t}`)
      : this._record(t, e, n);
  }
}
class mo extends lo {
...
class fo extends lo {
  record(t, e, n) {
    t < 0
      ? It.warn(`negative value provided to histogram ${this._descriptor.name}: ${t}`)
      : this._record(t, e, n);
  }
}
class go {
...
class xo {
  ...
  getOrDefault(t, e) {
    ...
    const r = e();
    return (this._keyMap.has(n) || this._keyMap.set(n, t), this._valueMap.set(n, r), r);
  }
  set(t, e, n) {
    ((n ??= this._hash(t)),
  ...
  *entries() {
    ...
    let e = t.next();
    for (; !0 !== e.done; )
      (yield [this._keyMap.get(e.value[0]), e.value[1], e.value[0]], (e = t.next()));
  }
  get size() {
  ...
  record(t, e, n, r) {
    ...
    if (!i) {
      if (this._activeCollectionStorage.size >= this._cardinalityLimit) {
        const e = this._activeCollectionStorage.getOrDefault(this._overflowAttributes, () =>
          this._aggregator.createAccumulation(r)
        );
        return void e?.record(t);
      }
      ((i = this._aggregator.createAccumulation(r)), this._activeCollectionStorage.set(e, i));
    }
    i?.record(t);
  }
  batchCumulate(t, e) {
    Array.from(t.entries()).forEach(([t, n, r]) => {
      ...
      (this._cumulativeMemoStorage.set(t, i, r), this._activeCollectionStorage.set(t, s, r));
    });
  }
  collect() {
...
class Ao {
  ...
  buildMetrics(t, e, n, r) {
    ...
    this._reportHistory.set(t, { accumulations: o, collectionTime: r, aggregationTemporality: s });
  ...
  _stashAccumulations(t) {
    ...
    for (const n of e) {
      ...
      (void 0 === e && ((e = []), this._unreportedAccumulations.set(n, e)), e.push(t));
    }
  }
    ...
    for (const r of e) {
      ...
      co(e, t)
        ? (e.description !== t.description &&
            (t.description.length > e.description.length && r.updateDescription(t.description),
            It.warn(
...
class Mo {
  ...
  observe(t, e = {}) {
    'number' == typeof t
      ...
      : It.warn(`non-number value provided to metric ${this._instrumentName}: ${t}`);
  }
}
class Ro {
  _buffer = new Map();
    ...
    (null == r && ((r = new Eo()), this._buffer.set(t, r)),
      'number' == typeof e
        ? (t._descriptor.valueType !== P.INT ||
            ...
            Number.isInteger(e))) &&
          r.set(n, e)
        : It.warn(`non-number value provided to metric ${t._descriptor.name}: ${e}`));
  }
}
class No {
  _callbacks = [];
  _batchCallbacks = [];
  addCallback(t, e) {
    this._findCallback(t, e) >= 0 || this._callbacks.push({ callback: t, instrument: e });
  }
  removeCallback(t, e) {
  ...
  addBatchCallback(t, e) {
    ...
    if (0 === n.size)
      return void It.error('BatchObservableCallback is not associated with valid instruments', e);
...
class Io extends So {
  ...
  record(t, e, n, r) {
    ((e = this._attributesProcessor.process(e, n)), this._deltaMetricStorage.record(t, e, n, r));
  }
  collect(t, e) {
    const n = this._deltaMetricStorage.collect();
    return this._temporalMetricStorage.buildMetrics(t, this._instrumentDescriptor, n, e);
...
class jo {
  ...
  async collect(t, e, n) {
    ...
    return 0 === s.length
      ? { errors: r }
      : { scopeMetrics: { scope: this._instrumentationScope, metrics: s }, errors: r };
  }
...
class Bo {
  ...
  getMeterSharedState(t) {
    ...
    return (null == n && ((n = new jo(this, t)), this.meterSharedStates.set(e, n)), n);
  }
  selectAggregations(t) {
    const e = [];
    for (const n of this.metricCollectors) e.push([n, to(n.selectAggregation(t))]);
    return e;
  }
}
class Fo {
  ...
  async collect(t) {
    ...
    return (
      await Promise.all(i),
      { resourceMetrics: { resource: this._sharedState.resource, scopeMetrics: n }, errors: r }
    );
  }
  async forceFlush(t) {
...
class zo {
  ...
  constructor(t) {
    '*' === t
      ...
      : ((this._matchAll = !1), (this._regexp = new RegExp(zo.escapePattern(t))));
  }
  match(t) {
...
class qo {
  ...
  constructor(t) {
    ...
    (!(function (t) {
      ...
      var e;
      if (null != t.name && (null == t?.instrumentName || zo.hasWildcard(t.instrumentName)))
        throw new Error(
...
class Ko {
  ...
  _shutdown = !1;
  constructor(t) {
    if (((this._sharedState = new Bo(t?.resource ?? fe())), null != t?.views && t.views.length > 0))
      for (const e of t.views) this._sharedState.viewRegistry.addView(new qo(e));
  ...
  getMeter(t, e = '', n = {}) {
    return this._shutdown
      ...
      : this._sharedState.getMeterSharedState({ name: t, version: e, schemaUrl: n.schemaUrl })
          .meter;
  }
  async shutdown(t) {
    this._shutdown
...
class ra {
  ...
  getLoggerProvider() {
    var t, e;
    return null !== (e = null === (t = na[ea]) || void 0 === t ? void 0 : t.call(na, 1)) &&
      void 0 !== e
      ? e
      : this._proxyLoggerProvider;
  }
...
class sa {
  ...
  setAttribute(t, e) {
    return this._isLogRecordReadonly() || null === e
      ...
      : 0 === t.length
        ...
        : Zn(e) || ('object' == typeof e && !Array.isArray(e) && Object.keys(e).length > 0)
          ? ((this.totalAttributesCount += 1),
            Object.keys(this.attributes).length >= this._logRecordLimits.attributeCountLimit &&
            !Object.prototype.hasOwnProperty.call(this.attributes, t)
              ? (1 === this.droppedAttributesCount && It.warn('Dropping extra attributes.'), this)
              : (Zn(e) ? (this.attributes[t] = this._truncateToSize(e)) : (this.attributes[t] = e),
                this))
  ...
  _isLogRecordReadonly() {
    return (
      this._isReadonly && It.warn('Can not execute the operation on emitted log record'),
      this._isReadonly
    );
  }
}
class oa {
  ...
  emit(t) {
    const e = t.context || Nt.active(),
      n = new sa(this._sharedState, this.instrumentationScope, { context: e, ...t });
...
class la {
  ...
  constructor(t = {}) {
    const e = (function (...t) {
        ...
        {
          forceFlushTimeoutMillis: 3e4,
          logRecordLimits: { attributeValueLengthLimit: 1 / 0, attributeCountLimit: 128 },
    ...
    ((this._sharedState = new ua(
      ...
      {
        attributeCountLimit: (r = e.logRecordLimits).attributeCountLimit ?? void 0 ?? void 0 ?? 128,
    ...
    return (
      this._sharedState.loggers.has(i) ||
        this._sharedState.loggers.set(
          i,
          new oa({ name: r, version: e, schemaUrl: n?.schemaUrl }, this._sharedState)
        ),
  ...
  forceFlush() {
    return this._shutdownOnce.isCalled
      ? (It.warn('invalid attempt to force flush after LoggerProvider shutdown'),
        this._shutdownOnce.promise)
      : this._sharedState.activeProcessor.forceFlush();
  }
  shutdown() {
    return this._shutdownOnce.isCalled
      ? (It.warn('shutdown may only be called once per LoggerProvider'), this._shutdownOnce.promise)
      ...
      Mr._export(this._exporter, [t])
        .then((t) => {
          t.code !== dr.SUCCESS &&
            nr(
              t.error ??
                new Error(`SimpleLogRecordProcessor: log record export failed (status ${t})`)
            );
        })
        .catch(nr);
...
class pa {
  constructor(t = {}) {
    var e, n, r;
    if (
      ((this._resource = fe().merge(null !== (e = t.resource) && void 0 !== e ? e : pe({}))),
      (this._resourceDetectors = null !== (n = t.resourceDetectors) && void 0 !== n ? n : [Jn]),
      (this._serviceName = t.serviceName),
      (this._serviceVersion = t.serviceVersion),
      (this._autoDetectResources = null === (r = t.autoDetectResources) || void 0 === r || r),
    ...
    (t.metricExporters && (this._meterProviderConfig = { metricExporters: t.metricExporters }),
      t.logExporters && (this._loggerProviderConfig = { logExporters: t.logExporters }));
    let i = [];
  ...
  start() {
    ...
    ((this._resource =
      ...
      void 0 !== this._serviceVersion &&
        (this._resource = this._resource.merge(pe({ [Vn]: this._serviceVersion }))));
    const s = [];
    ((null === (t = this._tracerProviderConfig) || void 0 === t ? void 0 : t.spanProcessor) &&
      s.push(this._tracerProviderConfig.spanProcessor),
      (null === (e = this._tracerProviderConfig) || void 0 === e ? void 0 : e.spanProcessors) &&
        s.push(...this._tracerProviderConfig.spanProcessors));
    const o = new jn(
      Object.assign(
        Object.assign(
          {},
          null === (n = this._tracerProviderConfig) || void 0 === n ? void 0 : n.tracerConfig
        ),
    ...
    if (
      ...
      o.register({
        contextManager:
          null === (r = this._tracerProviderConfig) || void 0 === r ? void 0 : r.contextManager,
        propagator:
          null === (i = this._tracerProviderConfig) || void 0 === i ? void 0 : i.textMapPropagator,
      }),
      this._meterProviderConfig)
    ) {
      const t = this._meterProviderConfig.metricExporters.map((t) => new io({ exporter: t }));
    ...
    if (this._loggerProviderConfig) {
      ...
      ((this._loggerProvider = new la({ resource: this._resource, processors: t })),
...
function Ta(t) {
  return (
    null != t && 0 !== t.length && (32 === t.length ? xa.test(t) : 64 === t.length && Ea.test(t))
  );
}
function Aa(t, e) {
  return t.endsWith(e) || t.endsWith(`${e}/`) ? t : t.endsWith('/') ? t + e : t + '/' + e;
}
const Ca = (t) =>
  ...
  Oa = (t) =>
    (null == t ? void 0 : t.logsEndpoint)
      ...
      : (null == t ? void 0 : t.endpoint)
        ? Aa(t.endpoint, ba)
        : ya,
  ka = (t) => (null == t ? void 0 : t.tracesApiKey) || (null == t ? void 0 : t.apiKey),
  La = (t) =>
    ...
    (null == t ? void 0 : t.sampleRate) >= 0
      ? null == t
        ...
        : t.sampleRate
      : 1,
  Ma = Sa('❌ Missing API Key. Set `apiKey` in HoneycombOptions. Telemetry will not be exported.'),
  Ra = Sa(
  ...
  Na =
    ...
    Sa('⏭️ Skipping options validation, because a custom collector is being used.'),
    Sa(
    ...
    Sa('🔕 Disabling local visualizations - must have both service name and API key configured.'),
    Sa('🔕 Disabling local visualizations - cannot infer auth and ui url roots from endpoint url.'),
    Sa('🔕 Failed to get proper auth response from Honeycomb. No local visualization available.'),
      ...
      if (
        ...
        return (
          ...
          !0 === (null == t ? void 0 : t.disableDefaultTraceExporter) &&
            ...
            (null === (n = null == t ? void 0 : t.traceExporters) || void 0 === n || n.length),
          t
        );
      v.DEBUG;
    });
function Ia(t) {
  ...
  (It.setLogger(new M(), v.DEBUG), It.debug(Sa('🐝 Honeycomb Web SDK Debug Mode Enabled 🐝')));
  const e = Ca(t),
    n = Object.assign(Object.assign(Object.assign({}, wa), t), { tracesEndpoint: e });
  (!(function (t) {
    const e = ka(t) || '';
    ...
    (function (t) {
      ...
      It.debug(`@honeycombio/opentelemetry-web: Service Name configured for traces: '${e}'`);
    })(n),
    (function (t) {
      const e = Ca(t);
...
class Ua {
  ...
  shouldSample(t, e, n, r, i, s) {
    ...
    return Object.assign(Object.assign({}, o), {
      attributes: Object.assign(Object.assign({}, o.attributes), { SampleRate: this._sampleRate }),
    });
  }
  toString() {
...
const ja = () => {
  ...
  Ga = (t) => {
    ...
    try {
      for (; 9 !== t?.nodeType; ) {
        const n = t,
          r = n.id ? '#' + n.id : [Fa(n), ...Array.from(n.classList).sort()].join('.');
    ...
    return (o) => {
      ...
      e.value >= 0 &&
        ...
        (s || void 0 === i) &&
          ...
          (e.delta = s),
          (e.rating =
            (a = e.value) > (c = n)[1] ? 'poor' : a > c[0] ? 'needs-improvement' : 'good'),
          t(e)));
    };
  },
  Xa = (t) => {
...
let tc = -1;
const ec = () => ('hidden' !== document.visibilityState || document.prerendering ? 1 / 0 : 0),
  nc = (t) => {
    'hidden' === document.visibilityState &&
      tc > -1 &&
  ...
  rc = () => {
    (addEventListener('visibilitychange', nc, !0), addEventListener('prerenderingchange', nc, !0));
  },
  ic = () => {
        ...
        for (const e of t)
          'first-contentful-paint' === e.name &&
            ...
            e.startTime < n.firstHiddenTime &&
              ((i.value = Math.max(e.startTime - Ya(), 0)), i.entries.push(e), r(!0)));
      });
      s &&
  ...
  wc = (t, e = {}) => {
    ...
    const u = () => {
      ...
      l = () => {
        ...
        ((r = r.filter((t, e) => (t.startTime > s && e > u) || a.has(t))), (c = !1));
      };
    ((n.m = (t) => {
        ...
        globalThis.PerformanceEventTiming &&
          ...
          oc(() => {
            'interactionCount' in performance ||
              fc ||
              (fc = Qa('event', mc, { type: 'event', buffered: !0, durationThreshold: 0 }));
            let n,
              r = Ja('INP');
            const i = Va(e, vc),
              s = (t) => {
                bc(() => {
                  ...
                  const e = i.M();
                  e && e.T !== r.value && ((r.value = e.T), (r.entries = e.entries), n());
                });
              },
              o = Qa('event', s, { durationThreshold: e.durationThreshold ?? 40 });
            ((n = Ka(t, r, yc, e.reportAllChanges)),
              o &&
                (o.observe({ type: 'first-input', buffered: !0 }),
                document.addEventListener('visibilitychange', () => {
                  'hidden' === document.visibilityState && (s(o.takeRecords()), n(!0));
                }),
                qa(() => {
                  (i.v(), (r = Ja('INP')), (n = Ka(t, r, yc, e.reportAllChanges)));
                })));
          });
      })((e) => {
        const r = ((t) => {
          ...
          return (
            ((t) => {
              ...
              (d >= e + n + r && (c = t.nextPaintTime - d),
                i && s && (t.longestScript = { entry: i, subpart: s, intersectingDuration: u }),
  ...
  constructor({
    ...
    (super('@honeycombio/instrumentation-web-vitals', Rr, {
      ...
      (this.onReportINP = (t, e = { includeTimingsAsSpans: !1 }) => {
        const { applyCustomAttributes: n, includeTimingsAsSpans: r, dataAttributes: i } = e;
        if (!this.isEnabled()) return;
    ...
    (this.vitalsToTrack.includes('CLS') &&
                ...
                const s = Va(e, Sc),
                  o = (t) => {
                    ...
                    for (const e of t)
                      (s.u(e),
                        e.startTime < n.firstHiddenTime &&
                          ((i.value = Math.max(e.startTime - Ya(), 0)), (i.entries = [e]), r()));
                  },
                ...
                if (t.entries.length) {
                  ...
                  if (n) {
                    const i = n.activationStart || 0,
                      ...
                      o =
                        s.url &&
                        performance.getEntriesByType('resource').filter((t) => t.name === s.url)[0],
                      a = Math.max(0, n.responseStart - i),
                      c = Math.max(a, o ? (o.requestStart || o.startTime) - i : 0),
                      u = Math.min(t.value, Math.max(c, o ? o.responseEnd - i : 0));
                    ((e = {
                      target: r.get(s),
                      timeToFirstByte: a,
          ...
          ((t, e = {}) => {
            ...
            Tc(() => {
              ...
              i &&
                ...
                r(!0),
                qa(() => {
                  ((n = Ja('TTFB', 0)), (r = Ka(t, n, Ec, e.reportAllChanges)), r(!0));
                }));
            });
          })((e) => {
            const n = ((t) => {
      ...
      this.vitalsToTrack.includes('FCP') &&
        ((t, e = {}) => {
          cc((e) => {
            const n = ((t) => {
              let e = { timeToFirstByte: 0, firstByteToFCP: t.value, loadState: Ba(Wa()) };
              if (t.entries.length) {
                const n = ja(),
                  r = t.entries.at(-1);
                if (n) {
      ...
      Object.assign(
        ...
        (function (t) {
          ...
          return Array.isArray(e)
            ? (e.forEach((t) => {
                (n.push(t.line), r.push(t.column), i.push(t.func), s.push(t.url));
              }),
              {
  ...
  return (
    ...
    Ta(e) &&
      (r && (null == t ? void 0 : t.metricsDataset)
        ...
        : (null == t ? void 0 : t.dataset) && (i[Tl] = null == t ? void 0 : t.dataset)),
    i
  );
}
const Cl = (t = '') => {
...
class Pl {
  constructor(t, e, n, r, i) {
    if (((this._traceUrl = ''), (this._logLevel = v.DEBUG), n && (this._logLevel = n), !t || !e))
    ...
    fetch(r, { headers: { 'x-honeycomb-team': e } })
      ...
      .then((n) => {
        var r, s, o;
        const a = n;
        if (!(null === (r = a.team) || void 0 === r ? void 0 : r.slug)) throw new Error();
  ...
  export(t, e) {
    (this._traceUrl &&
      t.forEach((t) => {
        var e;
        !(null === (e = t.parentSpanContext) || void 0 === e ? void 0 : e.spanId) &&
          (this._logLevel, v.INFO);
      }),
      e({ code: dr.SUCCESS }));
  }
  ...
  return (
    (null == t ? void 0 : t.localVisualizations) &&
      e.push(
        (function (t) {
          const e = ka(t),
            { authRoot: n, uiRoot: r } = Cl((null == t ? void 0 : t.tracesEndpoint) || Ca(t));
          return new Pl(
    ...
    (null == t ? void 0 : t.traceExporter) && e.push(null == t ? void 0 : t.traceExporter),
      ...
      e.unshift(
        (function (t) {
          ...
          return new Hi({
            ...
            timeoutMillis:
              (null == t ? void 0 : t.tracesTimeout) || (null == t ? void 0 : t.timeout) || 1e4,
          });
        })(t)
      ),
    (n = [...e]),
  ...
  return (
    ...
    !0 !== (null == t ? void 0 : t.disableDefaultMetricExporter) &&
      e.unshift(
        (function (t) {
          const e = ((t) =>
            (null == t ? void 0 : t.metricsApiKey) || (null == t ? void 0 : t.apiKey))(t);
          return new ts({
            url: Pa(t),
            headers: Al(t, e, null == t ? void 0 : t.metricsHeaders, !0),
            timeoutMillis:
              (null == t ? void 0 : t.metricsTimeout) || (null == t ? void 0 : t.timeout) || 1e4,
          });
        })(t)
      ),
...
function Ll(t) {
  ...
  return (
    e.push(
      (function (t) {
        const e = ((t) => (null == t ? void 0 : t.logsApiKey) || (null == t ? void 0 : t.apiKey))(
          t
        );
        return new es({
          url: Oa(t),
          ...
          timeoutMillis:
            (null == t ? void 0 : t.logsTimeout) || (null == t ? void 0 : t.timeout) || 1e4,
        });
      })(t)
    ),
...
class Rl {
  ...
  onStart(t, e) {
    var n, r;
    (null !== (r = null === (n = qt.getBaggage(e)) || void 0 === n ? void 0 : n.getAllEntries()) &&
    void 0 !== r
      ? r
      : []
    ).forEach((e) => {
...
class Nl {
  constructor() {}
  onStart(t) {
    const { href: e, pathname: n, search: r, hash: i, hostname: s } = window.location;
    t.setAttributes({
...
const Gl = { path: !0, hash: !0, hostname: !0, referrer: !0, url: !1, search: !1 };
function zl(t) {
  if (!1 === t || !(null === window || void 0 === window ? void 0 : window.location)) return pe({});
  const e = (function (t) {
      if (!t) return Gl;
...
function Hl() {
  ...
  return pe({
    ...
    [Mc]:
      ...
      null !== (s = null == i ? void 0 : i.effectiveType) && void 0 !== s ? s : 'unknown'),
    [Rc]: window.screen.width,
    [Nc]: window.screen.height,
    [Ic]:
      ((r = window.screen.width),
      r <= 768 ? 'small' : r > 768 && r <= 1024 ? 'medium' : r > 1024 ? 'large' : 'unknown'),
  });
}
const Wl = (t) => {
  let e = pe({});
  return (
    ...
    (e = e.merge(
      pe({ [Kc]: Rr, [Xc]: 'browser', [Bl]: '@honeycombio/opentelemetry-web', [Fl]: Rr })
    )),
    (null == t ? void 0 : t.resource) && (e = e.merge(t.resource)),
    (null == t ? void 0 : t.resourceAttributes) && (e = e.merge(pe(t.resourceAttributes))),
    e
  );
};
class ql extends pa {
  constructor(t) {
    ...
    (!1 !==
      (null === (e = null == t ? void 0 : t.webVitalsInstrumentationConfig) || void 0 === e
        ? void 0
        : e.enabled) && r.push(new yl(null == t ? void 0 : t.webVitalsInstrumentationConfig)),
      !1 !==
        (null === (n = null == t ? void 0 : t.globalErrorsInstrumentationConfig) || void 0 === n
          ? void 0
          : n.enabled) && r.push(new xl(null == t ? void 0 : t.globalErrorsInstrumentationConfig)),
      super(
  ...
  return Xt.getTracer(Kl).startActiveSpan(
    ...
    async (t) => {
      try {
        ...
        throw (t.setStatus({ code: Pt.ERROR, message: n.message }), t.recordException(n), n);
      } finally {
        t.end();
      }
    }
...
function Yl(t) {
  const e = '0123456789abcdef',
    n = Array.from({ length: 32 }, () => e[Math.floor(16 * Math.random())]).join(''),
    r = Array.from({ length: 16 }, () => e[Math.floor(16 * Math.random())]).join(''),
    i = {
...
function Jl() {
  ...
  try {
    new ql({
      ...
      serviceName: Kl,
      sampleRate: 1,
      resourceAttributes: { 'extension.version': e.version, 'build.type': 'external' },
...
class Ql {
  ...
  async checkPermission(t, e) {
    ...
    const { host: n } = new URL(t);
    if (!this.forcePrompt && this.isTurnApprovedDomain(n)) return { allowed: !0, needsPrompt: !1 };
    await this.loadPermissions();
    const i = this.findApplicablePermission(n, e);
    return i
      ? ((i.lastUsed = Date.now()),
        await this.savePermissions(),
        { allowed: i.action === r.ALLOW, permission: i })
  ...
  async checkDomainTransition(t, e) {
    ...
    const n = this.permissions.filter(
        (n) =>
          'domain_transition' === n.scope.type && n.scope.fromDomain === t && n.scope.toDomain === e
      ),
      i = n.find((t) => t.action === r.DENY);
    if (i)
      return (
        (i.lastUsed = Date.now()),
        await this.savePermissions(),
    ...
    const s = n.find((t) => t.action === r.ALLOW);
    return s
      ? ((s.lastUsed = Date.now()), await this.savePermissions(), { allowed: !0, permission: s })
  ...
  async denyPermission(t, e) {
    ...
    (e === i.ALWAYS && this.permissions.push(n), await this.savePermissions(), this.clearCache());
  }
  ...
  async clearOncePermissions() {
    ...
    this.permissions = this.permissions.filter((t) => t.duration !== i.ONCE);
    t - this.permissions.length > 0 && (await this.savePermissions(), this.clearCache());
  }
  getPermissionsByScope() {
    return {
      netloc: this.permissions.filter((t) => 'netloc' === t.scope.type),
      domain_transition: this.permissions.filter((t) => 'domain_transition' === t.scope.type),
    };
  }
  getAllPermissions() {
  ...
  findApplicablePermission(t, e) {
    ...
    const s = this.permissions.filter(
      ...
      o = s.find((t) => t.action === r.DENY);
    if (o) return (this.cache.set(n, o), o);
    const a = s.find((t) => t.action === r.ALLOW);
    return a ? (this.cache.set(n, a), a) : null;
  }
  ...
  async loadPermissions() {
    try {
      const t = await s(o.PERMISSION_STORAGE);
  ...
  async savePermissions() {
    try {
      ...
      await a(o.PERMISSION_STORAGE, t);
    } catch (t) {}
  }
  setupStorageListener() {
    chrome.storage.onChanged.addListener((t, e) => {
      'local' === e && t[o.PERMISSION_STORAGE] && (this.loadPermissions(), this.clearCache());
    });
  }
  clearCache() {
    this.cache.clear();
  ...
  isLocalhostUrl(t) {
    try {
      const e = new URL(t),
        n = e.protocol;
      return ('http:' === n || 'https:' === n) && this.isLocalhostDomain(e.hostname);
    } catch {
      return !1;
    }
  }
...
function fd(...t) {
  ...
  return (t, n = 0, r = 0) => {
    ...
    return (function (t) {
      ...
      (e.reverse(),
        md.test(gd(e).function || '') && (e.pop(), md.test(gd(e).function || '') && e.pop()));
      return e
        .slice(0, 50)
        .map((t) => ({ ...t, filename: t.filename || gd(e).filename, function: t.function || hd }));
    })(i.slice(r));
  };
}
function gd(t) {
...
function Dd(t) {
  return null === t || Id(t) || ('object' != typeof t && 'function' != typeof t);
}
function Ud(t) {
  return Ld(t, 'Object');
}
...
function zd(t, e = {}) {
  ...
  try {
    ...
    for (
      ...
      n &&
      s++ < r &&
      ((u = Vd(n, l)), !('html' === u || (s > 1 && o + i.length * c + u.length >= d)));
    )
...
function Kd(t, e, n = !1) {
  return !!Nd(t) && (Ld(e, 'RegExp') ? e.test(t) : !!Nd(e) && (n ? t === e : t.includes(e)));
}
function Xd(t, e = [], n = !1) {
...
function th(t) {
  if (kd(t)) return { message: t.message, name: t.name, stack: t.stack, ...nh(t) };
  if ($d(t)) {
    const e = { type: t.type, target: eh(t.target), currentTarget: eh(t.currentTarget), ...nh(t) };
    return ('undefined' != typeof CustomEvent && Bd(t, CustomEvent) && (e.detail = t.detail), e);
  }
  return t;
}
function eh(t) {
  try {
    return (
      (e = t),
      'undefined' != typeof Element && Bd(e, Element) ? zd(t) : Object.prototype.toString.call(t)
    );
  } catch {
    return '<unknown>';
  }
...
function ih(
  ...
  return (
    ...
    rh.replace(/[018]/g, (t) => (t ^ (((16 * Math.random()) & 15) >> (t / 4))).toString(16))
  );
}
function sh(t) {
...
function fh(t, e, n = 2) {
  ...
  const r = { ...t };
  for (const i in e) Object.prototype.hasOwnProperty.call(e, i) && (r[i] = fh(r[i], e[i], n - 1));
  return r;
}
function gh() {
  return ih();
...
class wh {
  constructor() {
    ((this._notifyingListeners = !1),
      ...
      (this._propagationContext = { traceId: gh(), sampleRand: Math.random() }));
  }
  clone() {
    const t = new wh();
    return (
  ...
  addBreadcrumb(t, e) {
    ...
    if (n <= 0) return this;
    const r = { timestamp: lh(), ...t, message: t.message ? Wd(t.message, 2048) : t.message };
    return (
  ...
  setSDKProcessingMetadata(t) {
    return ((this._sdkProcessingMetadata = fh(this._sdkProcessingMetadata, t, 2)), this);
  }
  ...
  captureException(t, e) {
    ...
    if (!this._client)
      return (Zl && dd.warn('No client configured on scope - will not capture exception!'), n);
  ...
  captureMessage(t, e, n) {
    ...
    if (!this._client)
      return (Zl && dd.warn('No client configured on scope - will not capture message!'), r);
    const i = new Error(t);
    return (
  ...
  captureEvent(t, e) {
    ...
    return this._client
      ...
      : (Zl && dd.warn('No client configured on scope - will not capture event!'), n);
  }
      ...
      return !(
        ...
        (n.match(/^\d+$/)
          ? (function (t) {
            ...
            ? e && isNaN(parseInt(e, 10)) && (dd.error(`Invalid Sentry Dsn: Invalid port ${e}`), 1)
...
function qh(t) {
  return t && t.length > 0
    ? t.map(({ context: { spanId: t, traceId: e, traceFlags: n, ...r }, attributes: i }) => ({
        span_id: t,
        trace_id: e,
        sampled: 1 === n,
        attributes: i,
...
function Yh(t) {
  ...
  if (
    ...
    const { attributes: r, startTime: i, name: s, endTime: o, status: a, links: c } = t;
    return {
      span_id: e,
      trace_id: n,
      data: r,
...
function tp(t) {
  dd.log(`Ignoring span ${t.op} - ${t.description} because it matches \`ignoreSpans\`.`);
}
function ep(t, e) {
...
function up(
  ...
  const a = (function (t, e) {
    try {
      ...
      if (Ud((n = e)) && 'nativeEvent' in n && 'preventDefault' in n && 'stopPropagation' in n)
...
function bp(t, e, n, r) {
  ...
  !(function (t, e) {
    ...
    t.sdk = {
      ...
      settings: t.sdk?.settings || e.settings ? { ...t.sdk?.settings, ...e.settings } : void 0,
    };
  })(t, n?.sdk);
...
class Sp {
  ...
  _runExecutor(t) {
    const e = (t, e) => {
        0 === this._state &&
          (jd(e) ? e.then(n, r) : ((this._state = t), (this._value = e), this._executeHandlers()));
      },
      n = (t) => {
        e(1, t);
      },
...
function Ep(t, e, n, r) {
  ...
  const s = i({ ...t }, e);
  return (
    Zl && null === s && dd.log(`Event processor "${i.id || '?'}" dropped event`),
...
function Mp(t, e, n, r, i, s) {
  const { normalizeDepth: o = 3, normalizeMaxBreadth: a = 1e3 } = t,
    c = { ...e, event_id: e.event_id || n.event_id || ih(), timestamp: e.timestamp || lh() },
    u = n.integrations || t.integrations.map((t) => t.name);
  (!(function (t, e) {
    const { environment: n, release: r, dist: i, maxValueLength: s = 250 } = e;
    ((t.environment = t.environment || n || ip), !t.release && r && (t.release = r));
    !t.dist && i && (t.dist = i);
    const o = t.request;
      ...
      'number' == typeof o && o > 0
        ? (function (t, e, n) {
            ...
            t.contexts?.trace &&
              ...
              t.contexts.trace.data && (r.contexts.trace.data = ap(t.contexts.trace.data, e, n)));
            t.spans &&
              (r.spans = t.spans.map((t) => ({ ...t, ...(t.data && { data: ap(t.data, e, n) }) })));
            t.contexts?.flags && r.contexts && (r.contexts.flags = ap(t.contexts.flags, 3, n));
            return r;
          })(t, o, a)
        : t
    )
...
function Np(t) {
  const e = Oh(),
    ...
    i = ph({ user: n.getUser() || e.getUser(), ...(r && { userAgent: r }), ...t }),
    s = e.getSession();
  return ('ok' === s?.status && mh(s, { status: 'exited' }), Ip(), e.setSession(i), i);
}
function Ip() {
  const t = Oh(),
...
function Gp(t, e, n) {
  if (n[e.name]) Zl && dd.log(`Integration skipped because it was already installed: ${e.name}`);
  else {
    if (
      ((n[e.name] = e),
      -1 === jp.indexOf(e.name) &&
...
class rm {
  constructor(t) {
    ...
    (this._options.enableLogs && nm(this, 'afterCaptureLog', 'flushLogs', am, zp),
  ...
  captureMessage(t, e, n, r) {
    const i = { event_id: ih(), ...n },
      s = Id(t) ? t : String(t),
      o = Dd(t) ? this.eventFromMessage(s, e, i) : this.eventFromException(t, i);
    return (this._process(o.then((t) => this._captureEvent(t, i, r))), i.event_id);
  }
  captureEvent(t, e, n) {
    const r = ih();
    if (e?.originalException && uh(e.originalException)) return (Zl && dd.log(Kp), r);
    const i = { event_id: r, ...e },
  ...
  sendSession(t) {
    ...
    const r = (function (t, e, n, r) {
      ...
      return lp(
        ...
        ['aggregates' in t ? [{ type: 'sessions' }, t] : [{ type: 'session' }, t.toJSON()]]
      );
  ...
  _updateSessionFromEvent(t, e) {
    ...
    const s = 'ok' === t.status;
    ((s && 0 === t.errors) || (s && n)) &&
      (mh(t, { ...(n && { status: 'crashed' }), errors: t.errors || Number(r || n) }),
  ...
  _prepareEvent(t, e, n, r) {
    ...
    return (
      ...
      Mp(i, t, e, n, this, r).then((t) => {
        if (null === t) return t;
        (this.emit('postprocessEvent', t, e), (t.contexts = { trace: Lh(n), ...t.contexts }));
        const r = (function (t, e) {
          const n = e.getPropagationContext();
          return n.dsc || sp(n.traceId, t);
        })(this, n);
        return (
          (t.sdkProcessingMetadata = { dynamicSamplingContext: r, ...t.sdkProcessingMetadata }),
          t
        );
      })
    );
  ...
  _captureEvent(t, e = {}, n = Ph(), r = Oh()) {
    return (
      Zl && im(t) && dd.log(`Captured error event \`${qp(t)[0] || '<unknown>'}\``),
      this._processEvent(t, e, n, r).then(
        (t) => t.event_id,
        (t) => {
          Zl && (em(t) ? dd.log(t.message) : tm(t) ? dd.warn(t.message) : dd.warn(t));
        }
      )
    );
  }
    ...
    return this._prepareEvent(t, e, n, r)
      .then((t) => {
        ...
        const n = (function (t, e, n, r) {
          const { beforeSend: i, beforeSendTransaction: s, beforeSendSpan: o, ignoreSpans: a } = e;
          let c = n;
          ...
          if (sm(c)) {
            if (o || a) {
              ...
              if (c.spans) {
                ...
                (r && t.recordDroppedEvent('before_send', 'span', r), (c.spans = e));
              }
            }
            if (s) {
              if (c.spans) {
  ...
  _flushOutcomes() {
    ...
    if (!this._dsn) return void (Zl && dd.log('No dsn provided, will not send outcomes'));
...
function cm(t) {
  ...
  return (
    Object.values(t).forEach((t) => {
      Array.isArray(t) ? (e += t.length * um(t[0])) : Dd(t) ? (e += um(t)) : (e += 100);
    }),
    e
  );
}
    ...
    for (const a of s.trim().split(',')) {
      ...
      if (e)
        for (const a of e.split(';'))
          ('metric_bucket' === a && n && !n.split(';').includes('custom')) || (i[a] = r + o);
      else i.all = r + o;
    }
  else
    o
          ...
          e({ body: mp(o) }).then(
            (t) => (
              void 0 !== t.statusCode &&
                ...
                Zl &&
                dd.warn(`Sentry responded with status code ${t.statusCode} to sent event.`),
              (r = pm(r, t)),
              t
            ),
            (t) => {
              throw (
                a('network_error'),
                Zl && dd.error('Encountered error running transport request:', t),
                t
              );
            }
          )
...
function vm(t, e) {
  ...
  const o = { timestamp: lh(), ...t },
    a = i ? ad(() => i(o, e)) : o;
  null !== a && (n.emit && n.emit('beforeAddBreadcrumb', a, e), r.addBreadcrumb(a, s));
}
let bm;
...
function Cm(t, e, n, r, i, s) {
  ...
  o && (i.exception.values = Pm(t, e, r, s.originalException, n, i.exception.values, o, 0));
}
    ...
    Array.isArray(r.errors) &&
      r.errors.forEach((r, s) => {
        if (Bd(r, Error)) {
          ...
          const u = t(e, r),
            l = c.length;
          (km(u, `errors[${s}]`, l, a), (c = Pm(t, e, n, r, i, [u, ...c], u, l)));
        }
      }),
    c
  );
    ...
    processEvent(e) {
      ...
      try {
        if (
          ...
          return (
            Zl && dd.warn('Event dropped due to being a duplicate of previously captured event.'),
            null
          );
      } catch {}
      return (t = e);
        ...
        Yd(td, 'fetch', function (t) {
          return function (...e) {
            const n = new Error(),
              { method: r, url: i } = (function (t) {
                ...
                if (2 === t.length) {
                  ...
                  return {
                    url: zm(e),
                    method: Gm(n, 'method') ? String(n.method).toUpperCase() : 'GET',
                  };
                }
                const e = t[0];
                return {
                  url: zm(e),
                  method: Gm(e, 'method') ? String(e.method).toUpperCase() : 'GET',
                };
              })(e),
              s = {
                args: e,
            ...
            return (
              Ed('fetch', { ...s }),
              t.apply(td, e).then(
                async (t) => (Ed('fetch', { ...s, endTimestamp: 1e3 * hh(), response: t }), t),
                (t) => {
                  if (
                    (Ed('fetch', { ...s, endTimestamp: 1e3 * hh(), error: t }),
                    kd(t) && void 0 === t.stack && ((t.stack = n.stack), Jd(t, 'framesToPop', 1)),
                    t instanceof TypeError &&
                      ('Failed to fetch' === t.message ||
                        'Load failed' === t.message ||
                        'NetworkError when attempting to fetch resource.' === t.message))
                  )
                    try {
...
function Vm(t) {
  ...
  try {
    ...
    if (((r = e), 'undefined' != typeof Request && Bd(r, Request))) return new Headers(e.headers);
  } catch {}
  var r;
}
const Hm = td;
...
function of(t, { isUnhandledRejection: e }) {
  ...
  if (Md(t)) return `Event \`ErrorEvent\` captured as ${r} with message \`${t.message}\``;
  if ($d(t)) {
...
class af extends rm {
  constructor(t) {
    const e =
      ((n = t),
      {
        release: 'string' == typeof __SENTRY_RELEASE__ ? __SENTRY_RELEASE__ : Hm.SENTRY_RELEASE?.id,
        sendClientReports: !0,
    ...
    (Hm.document &&
      ...
      Hm.document.addEventListener('visibilitychange', () => {
        'hidden' === Hm.document.visibilityState &&
          (i && this._flushOutcomes(), s && zp(this), o?.enableMetrics && Hp(this));
      }),
  ...
  eventFromException(t, e) {
    return (function (t, e, n, r) {
      ...
      return (ch(i), (i.level = 'error'), n?.event_id && (i.event_id = n.event_id), yp(i));
...
function ff(t, e = !1) {
  return (n) => {
    ...
    if (
      ...
      return;
    (Jd(n, '_sentryCaptured', !0), r && !r._sentryId && Jd(r, '_sentryId', ih()));
    ...
    if (
      ...
      (t({ event: n, name: i, global: e }), (df = n.type), (hf = r ? r._sentryId : void 0));
    }
    (clearTimeout(lf),
      (lf = uf.setTimeout(() => {
        ((hf = void 0), (df = void 0));
  ...
  ((t.open = new Proxy(t.open, {
    apply(t, e, n) {
      ...
      ((e[bf] = { method: s, url: o, request_headers: {} }),
        'POST' === s && o.match(/sentry_key/) && (e.__sentry_own_request__ = !0));
      const a = () => {
        const t = e[bf];
        if (t && 4 === e.readyState) {
          try {
          ...
          Ed('xhr', { endTimestamp: 1e3 * hh(), startTimestamp: i, xhr: e, virtualError: r });
        }
      };
      return (
        ...
        (e.setRequestHeader = new Proxy(e.setRequestHeader, {
          apply(t, e, n) {
            const [r, i] = n,
              s = e[bf];
            return (s && Nd(r) && Nd(i) && (s.request_headers[r.toLowerCase()] = i), t.apply(e, n));
          },
        })),
        t.apply(e, n)
      );
    ...
    (t.send = new Proxy(t.send, {
      apply(t, e, n) {
        ...
        return (Ed('xhr', { startTimestamp: 1e3 * hh(), xhr: e }), t.apply(e, n));
      },
    })));
}
function wf(
  ...
  e = (function (t) {
    ...
    if (r && 'function' == typeof r.createElement)
      try {
        ...
        cf &&
          dd.warn(`Could not create sandbox iframe for ${t} check, bailing to window.${t}: `, i);
      }
      ...
      [
        ...
        (t) => {
          ...
          if (e) {
            ...
            let t = e[3],
              n = e[1] || hd;
            return (([n, t] = kf(n, t)), Sf(t, n, e[4] ? +e[4] : void 0, e[5] ? +e[5] : void 0));
          }
        },
      ],
    ]
              ...
              (function (t) {
                return function (e) {
                  ...
                  const { method: s, url: o, status_code: a, body: c } = i,
                    ...
                    l = { xhr: e.xhr, input: c, startTimestamp: n, endTimestamp: r },
                    d = { category: 'xhr', data: u, type: 'http', level: Um(a) };
                ...
                return function (e) {
                  ...
                  if (r && (!e.fetchData.url.match(/sentry_key/) || 'POST' !== e.fetchData.method))
                    if ((e.fetchData.method, e.fetchData.url, e.error)) {
                      const i = e.fetchData,
                        s = { data: e.error, input: e.args, startTimestamp: n, endTimestamp: r },
                        o = { category: 'fetch', data: i, level: 'error', type: 'http' };
                      (t.emit('beforeOutgoingRequestBreadcrumb', o, s), vm(o, s));
                    } else {
                      const i = e.response,
                        s = { ...e.fetchData, status_code: i?.status };
                      (e.fetchData.request_body_size, e.fetchData.response_body_size);
                      const o = { input: e.args, response: i, startTimestamp: n, endTimestamp: r },
                        a = { category: 'fetch', data: s, type: 'http', level: Um(s.status_code) };
                      (t.emit('beforeOutgoingRequestBreadcrumb', a, o), vm(a, o));
                    }
                };
              })(t)
            ),
    ...
    return {
      ...
      setupOnce() {
        (e.setTimeout && Yd(Hm, 'setTimeout', Df),
          ...
          e.XMLHttpRequest && 'XMLHttpRequest' in Hm && Yd(XMLHttpRequest.prototype, 'send', $f));
...
function Df(t) {
  return function (...e) {
    ...
    return (
      (e[0] = Km(n, {
        mechanism: { handled: !1, type: `auto.browser.browserapierrors.${vd(t)}` },
      })),
      t.apply(this, e)
    );
  };
            ...
            !(function (t) {
              ...
              const { msg: i, url: s, line: o, column: a, error: c } = e,
                u = (function (t, e, n, r) {
                  ...
                  0 === c.length &&
                    c.push({ colno: u, filename: d, function: hd, in_app: !0, lineno: l });
                  return t;
...
const zf = () => ({
    ...
    preprocessEvent(t) {
      ...
      const e = (function () {
          ...
          return { url: t, headers: { ...(e && { Referer: e }), ...(n && { 'User-Agent': n }) } };
        })(),
...
const qf = () => {
  const t = Wf().filter(
    (t) => !['BrowserApiErrors', 'Breadcrumbs', 'GlobalHandlers'].includes(t.name)
  );
  !(function (t = {}) {
    const e = !t.skipBrowserExtensionCheck && Hf(),
      n = {
        ...t,
        enabled: !e && t.enabled,
        stackParser: ((r = t.stackParser || Of), Array.isArray(r) ? fd(...r) : r),
        integrations: Bp({
          integrations: t.integrations,
          defaultIntegrations: null == t.defaultIntegrations ? Wf() : t.defaultIntegrations,
        }),
