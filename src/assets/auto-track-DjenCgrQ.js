import { aN as t } from './Main-DIS361Sg.js';
import './permissions-BsMI2TUG.js';
function n(n, e, r, o) {
  var i = this;
  return n
    ? ((n instanceof Element ? [n] : 'toArray' in n ? n.toArray() : n).forEach(function (n) {
        n.addEventListener(
          'click',
          function (a) {
            var u,
              ...
              l =
                ...
                (null === (u = n.getElementsByTagName('a')[0]) || void 0 === u
                  ? void 0
                  : u.getAttribute('href')),
              h = t(
    ...
    ? (n instanceof HTMLFormElement && (n = [n]),
      n.forEach(function (n) {
        ...
        var a = function (a) {
            var u;
            a.preventDefault ? a.preventDefault() : (a.returnValue = !1);
            var c = e instanceof Function ? e(n) : e,
              s = r instanceof Function ? r(n) : r;
            t(
              i.track(c, s, null != o ? o : {}),
        ...
        u ? u(n).submit(a) : n.addEventListener('submit', a, !1);
      }),
      this)
    : this;
}
