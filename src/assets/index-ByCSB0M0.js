import { w as n } from './permissions-BsMI2TUG.js';
    ...
    if (o && a) {
      ...
      var u = (function (n, e) {
        ...
        var r = n.integrations
          ...
          o = [];
        return (
          (null !== (t = e.remotePlugins) && void 0 !== t ? t : []).forEach(function (n) {
      ...
      r.updateEvent(
        'integrations',
        n(n(n({}, r.event.integrations), null == s ? void 0 : s.integrations), u)
      );
    }
    return r;
  }
