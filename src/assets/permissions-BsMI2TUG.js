  ...
  return (
    o ||
      ...
      (s.exports = (function () {
        ...
        function r(t, r, n) {
          var a = null;
          if ((void 0 !== n && (a = '' + n), void 0 !== r.key && (a = '' + r.key), 'key' in r))
            for (var o in ((n = {}), r)) 'key' !== o && (n[o] = r[o]);
          else n = r;
          return (
            (r = n.ref),
            { $$typeof: e, type: t, key: a, ref: void 0 !== r ? r : null, props: n }
          );
        }
...
function h() {
  ...
  var y = {
    ...
    E = {};
  function _(e, t, r) {
    ((this.props = e), (this.context = t), (this.refs = E), (this.updater = r || y));
  }
  function w() {}
  function g(e, t, r) {
    ((this.props = e), (this.context = t), (this.refs = E), (this.updater = r || y));
  ...
  function O(t, r, n) {
    var a = n.ref;
    return { $$typeof: e, type: t, key: r, ref: void 0 !== a ? a : null, props: n };
  }
  function R(t) {
  ...
  function D(r, n, a, o, s) {
    ...
    var d,
      p = '' === o ? '.' : o + ':';
    if (T(r)) for (var y = 0; y < r.length; y++) l += D((o = r[y]), n, a, (i = p + I(o, y)), s);
    else if (
      'function' ==
      typeof (y =
    ...
    (p.createElement = function (e, t, r) {
      ...
      if (null != t)
        for (n in (void 0 !== t.key && (o = '' + t.key), t))
          v.call(t, n) && 'key' !== n && '__self' !== n && '__source' !== n && (a[n] = t[n]);
    ...
    (p.startTransition = function (e) {
      ...
      try {
        var n = e(),
          a = A.S;
        (null !== a && a(r, n),
          'object' == typeof n && null !== n && 'function' == typeof n.then && n.then(b, N));
      } catch (o) {
        N(o);
      } finally {
...
function T(e, t) {
  ...
  return new Promise((t, f) => {
    ...
    (d.accept || (d.accept = g), c || document.addEventListener('visibilitychange', h));
    let y = 1e3,
      m = 0;
    function E() {
      (document.removeEventListener('visibilitychange', h), window.clearTimeout(m), p.abort());
    }
    null == r ||
    ...
    async function A() {
      ...
      try {
        const r = await _(e, Object.assign(Object.assign({}, l), { headers: d, signal: p.signal }));
        (await T(r),
          await (async function (e, t) {
            ...
            w(
              (function (e, t, r) {
                ...
                return function (o, s) {
                  if (0 === o.length)
                    (null == r || r(n), (n = { data: '', event: '', id: '', retry: void 0 }));
                  else if (s > 0) {
        ...
        if (!p.signal.aborted)
          try {
            const e = null !== (r = null == i ? void 0 : i(n)) && void 0 !== r ? r : y;
  ...
  V = async (e, t) => {
    try {
      const r = new URLSearchParams(new URL(e).search),
        ...
        s = r.get('state');
      if (a) {
        return { success: !1, error: `Authentication failed: ${a}${o ? ' - ' + o : ''}` };
      }
        ...
        u = await (async (e, t, r, n) => {
          try {
            ...
            if (!a.ok) {
              ...
              return { success: !1, error: `Token exchange failed: ${a.status} ${e}` };
            }
      ...
      return { success: !1, error: u.error || 'Failed to exchange authorization code for token' };
    } catch (r) {
      return {
        success: !1,
        error:
          r instanceof Error ? r.message : 'An unexpected error occurred during authentication',
      };
    }
  },
  K = async () => {
...
class B {
  ...
  isRefreshing = !1;
  constructor(e) {
    this.config = { ...e, cacheTTL: e.cacheTTL ?? 3e5, storageKey: e.storageKey ?? 'features' };
  }
...
function X({ children: e }) {
  ...
  m.useEffect(() => {
    const e = (e) => {
      ...
      t = ((n = e), z || (z = new B({ fetchFeatures: W, onFeaturesUpdated: n })), z);
    var n;
    ((i.current = t),
...
function le(e, t, r) {
  ...
  for (
    ...
    o < s && '__proto__' != (a = '' + t[o++]) && 'constructor' !== a && 'prototype' !== a;
  )
    i = i[a] =
      o === s
        ? r
...
for (var fe, de = 256, pe = []; de--; ) pe[de] = (de + 256).toString(16).substring(1);
function he() {
  var e,
    t = 0,
    r = '';
...
class ye {
  ...
  static async savePrompt(e) {
    ...
    return (
      ...
      r.repeatType && 'none' !== r.repeatType && (await this.updateAlarmForPrompt(r)),
      r
    );
  }
  ...
  static async deletePrompt(e) {
    ...
    return (
      n.length !== t.length &&
      (r?.repeatType && 'none' !== r.repeatType && (await chrome.alarms.clear(e)),
  ...
  static async searchPrompts(e) {
    ...
    return t.filter(
      (e) =>
        e.prompt.toLowerCase().includes(r) || (e.command && e.command.toLowerCase().includes(r))
    );
  }
  ...
  static async updateAlarmForPrompt(e) {
    const t = e.id;
    if ((await chrome.alarms.clear(t), !e.repeatType || 'none' === e.repeatType || !e.specificTime))
      return;
    const r = new Date(),
    ...
    switch (e.repeatType) {
      ...
      case 'daily': {
        ...
        (e.setHours(n, a, 0, 0),
          ...
          await chrome.alarms.create(t, { when: e.getTime(), periodInMinutes: 1440 }));
        break;
      }
      case 'weekly': {
        ...
        (s.setDate(r.getDate() + o),
          s.setHours(n, a, 0, 0),
          await chrome.alarms.create(t, { when: s.getTime(), periodInMinutes: 10080 }));
        break;
      }
      case 'monthly': {
...
const me = Object.freeze(
  Object.defineProperty({ __proto__: null, SavedPromptsService: ye }, Symbol.toStringTag, {
    value: 'Module',
  })
);
var Ee = ((e) => (
